---
title: "AI辅助性能异常检测 ｜ AI-assisted Performance Anomaly Detection"
description: "AI辅助性能异常检测（AI-assisted Performance Anomaly Detection）是性能风险预警中的关键术语，主要用于利用 AI 对性能时序数据进行异常检测和趋势预警，帮助团队在软件测试与发布中做出更稳定的质量决策。"
section: "A"
related:
  - software-testing
  - test-strategy
...
order: 39
---
# AI辅助性能异常检测 ｜ AI-assisted Performance Anomaly Detection

<!-- TOC START -->
- [AI辅助性能异常检测 ｜ AI-assisted Performance Anomaly Detection](#ai辅助性能异常检测--ai-assisted-performance-anomaly-detection)
- [关于AI辅助性能异常检测的问题](#关于AI辅助性能异常检测的问题)
  - [术语定义与适用边界](#术语定义与适用边界)
  - [方法框架与实施步骤](#方法框架与实施步骤)
  - [关键指标与口径说明](#关键指标与口径说明)
  - [工程落地建议](#工程落地建议)
...
AI辅助性能异常检测（AI-assisted Performance Anomaly Detection）在软件测试语境里是“可执行方法”，不是“概念说明”。它的价值在于把质量决策结构化：谁提供证据、谁做判断、谁承担结果。
...
- [Medium（术语检索）](https://medium.com/search?q=AI-assisted%20Performance%20Anomaly%20Detection)
- [GitHub（术语检索）](https://github.com/search?q=AI-assisted%20Performance%20Anomaly%20Detection&type=repositories)
...
- [Test case - Wikipedia](https://en.wikipedia.org/wiki/Test_case)
  ...
  - 来源域名：en.wikipedia.org（HTTP 200）
- [ISTQB Glossary](https://glossary.istqb.org/en_US/search?term=AI-assisted%20Performance%20Anomaly%20Detection)
  - 摘要：未提取到可用摘要
  - 来源域名：glossary.istqb.org（HTTP 200）
- [A global community of practice for software testing, quality | Ministry of Testing](https://www.ministryoftesting.com/search?query=AI-assisted%20Performance%20Anomaly%20Detection)
...
- [A global community of practice for software testing, quality | Ministry of Testing](https://www.ministryoftesting.com/search?query=AI-assisted+Performance+Anomaly+Detection)
  - 摘要：Join the Ministry of Testing community - a great place to learn all things testing and quality engineering, connect with like minded people interested in software quality, and contribute to the advancement of the softwar...
  - 来源域名：www.ministryoftesting.com（HTTP 200）
