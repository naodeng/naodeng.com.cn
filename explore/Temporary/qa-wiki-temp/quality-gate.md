...
description: "质量门禁（Quality Gate）是自动化质量控制中的关键术语，主要用于在 CI/CD 关键节点设置质量阈值，未达标即阻断发布，帮助团队在软件测试与发布中做出更稳定的质量决策。"
section: "Q"
related:
  - software-testing
  - test-strategy
...
质量门禁（Quality Gate）在软件测试语境里是“可执行方法”，不是“概念说明”。它的价值在于把质量决策结构化：谁提供证据、谁做判断、谁承担结果。
...
- [Medium（术语检索）](https://medium.com/search?q=Quality%20Gate)
- [Wikipedia（术语检索）](https://zh.wikipedia.org/wiki/Special:Search?search=%E8%B4%A8%E9%87%8F%E9%97%A8%E7%A6%81)
...
- [Test case - Wikipedia](https://en.wikipedia.org/wiki/Test_case)
  ...
  - 来源域名：en.wikipedia.org（HTTP 200）
- [ISTQB Glossary](https://glossary.istqb.org/en_US/search?term=Quality%20Gate)
  - 摘要：未提取到可用摘要
  - 来源域名：glossary.istqb.org（HTTP 200）
- [Search | Atlassian](https://www.atlassian.com/search?query=Quality%20Gate)
  - 摘要：Search the Atlassian website for product information and resources
  - 来源域名：www.atlassian.com（HTTP 200）
- [Search | Atlassian](https://www.atlassian.com/search?query=Quality+Gate)
  - 摘要：Search the Atlassian website for product information and resources
  - 来源域名：www.atlassian.com（HTTP 200）
