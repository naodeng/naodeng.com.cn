---
title: "质量成本 ｜ Cost of Quality"
description: "质量成本（Cost of Quality）是质量投入产出中的关键术语，主要用于量化预防、鉴定、内部失败、外部失败四类质量成本，帮助团队在软件测试与发布中做出更稳定的质量决策。"
section: "C"
related:
  - software-testing
  - test-strategy
...
<!-- TOC START -->
- [质量成本 ｜ Cost of Quality](#质量成本--cost-of-quality)
- [关于质量成本的问题](#关于质量成本的问题)
  - [术语定义与适用边界](#术语定义与适用边界)
  - [方法框架与实施步骤](#方法框架与实施步骤)
  - [关键指标与口径说明](#关键指标与口径说明)
...
质量成本（Cost of Quality）在软件测试语境里是“可执行方法”，不是“概念说明”。它的价值在于把质量决策结构化：谁提供证据、谁做判断、谁承担结果。
...
- [Medium（术语检索）](https://medium.com/search?q=Cost%20of%20Quality)
- [Wikipedia（术语检索）](https://zh.wikipedia.org/wiki/Special:Search?search=%E8%B4%A8%E9%87%8F%E6%88%90%E6%9C%AC)
...
- [Test case - Wikipedia](https://en.wikipedia.org/wiki/Test_case)
  ...
  - 来源域名：en.wikipedia.org（HTTP 200）
- [ISTQB Glossary](https://glossary.istqb.org/en_US/search?term=Cost%20of%20Quality)
  - 摘要：未提取到可用摘要
  - 来源域名：glossary.istqb.org（HTTP 200）
- [Search | Atlassian](https://www.atlassian.com/search?query=Cost%20of%20Quality)
  - 摘要：Search the Atlassian website for product information and resources
  - 来源域名：www.atlassian.com（HTTP 200）
- [Search | Atlassian](https://www.atlassian.com/search?query=Cost+of+Quality)
  - 摘要：Search the Atlassian website for product information and resources
  - 来源域名：www.atlassian.com（HTTP 200）
