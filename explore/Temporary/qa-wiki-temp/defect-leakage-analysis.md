---
title: "缺陷漏测分析 ｜ Defect Leakage Analysis"
description: "缺陷漏测分析（Defect Leakage Analysis）是漏测治理中的关键术语，主要用于分析测试阶段未发现、但在后续阶段暴露的缺陷来源，帮助团队在软件测试与发布中做出更稳定的质量决策。"
section: "D"
related:
  - software-testing
  - test-strategy
...
order: 22
---
# 缺陷漏测分析 ｜ Defect Leakage Analysis

<!-- TOC START -->
- [缺陷漏测分析 ｜ Defect Leakage Analysis](#缺陷漏测分析--defect-leakage-analysis)
- [关于缺陷漏测分析的问题](#关于缺陷漏测分析的问题)
  - [术语定义与适用边界](#术语定义与适用边界)
  - [方法框架与实施步骤](#方法框架与实施步骤)
  - [关键指标与口径说明](#关键指标与口径说明)
  - [工程落地建议](#工程落地建议)
...
缺陷漏测分析（Defect Leakage Analysis）在软件测试语境里是“可执行方法”，不是“概念说明”。它的价值在于把质量决策结构化：谁提供证据、谁做判断、谁承担结果。
...
- [Medium（术语检索）](https://medium.com/search?q=Defect%20Leakage%20Analysis)
- [Wikipedia（术语检索）](https://zh.wikipedia.org/wiki/Special:Search?search=%E7%BC%BA%E9%99%B7%E6%BC%8F%E6%B5%8B%E5%88%86%E6%9E%90)
...
- [Test case - Wikipedia](https://en.wikipedia.org/wiki/Test_case)
  ...
  - 来源域名：en.wikipedia.org（HTTP 200）
- [ISTQB Glossary](https://glossary.istqb.org/en_US/search?term=Defect%20Leakage%20Analysis)
  - 摘要：未提取到可用摘要
  - 来源域名：glossary.istqb.org（HTTP 200）
- [Search | Atlassian](https://www.atlassian.com/search?query=Defect%20Leakage%20Analysis)
  - 摘要：Search the Atlassian website for product information and resources
  - 来源域名：www.atlassian.com（HTTP 200）
- [Search | Atlassian](https://www.atlassian.com/search?query=Defect+Leakage+Analysis)
  - 摘要：Search the Atlassian website for product information and resources
  - 来源域名：www.atlassian.com（HTTP 200）
