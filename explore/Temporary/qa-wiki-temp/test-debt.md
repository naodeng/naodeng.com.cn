---
title: "测试债 ｜ Test Debt"
description: "测试债（Test Debt）是长期质量风险中的关键术语，主要用于指由于测试资产欠账导致未来质量风险和维护成本上升，帮助团队在软件测试与发布中做出更稳定的质量决策。"
section: "T"
related:
  - software-testing
  - test-strategy
...
测试债（Test Debt）在软件测试语境里是“可执行方法”，不是“概念说明”。它的价值在于把质量决策结构化：谁提供证据、谁做判断、谁承担结果。
...
- [Medium（术语检索）](https://medium.com/search?q=Test%20Debt)
- [Wikipedia（术语检索）](https://zh.wikipedia.org/wiki/Special:Search?search=%E6%B5%8B%E8%AF%95%E5%80%BA)
...
- [Test case - Wikipedia](https://en.wikipedia.org/wiki/Test_case)
  ...
  - 来源域名：en.wikipedia.org（HTTP 200）
- [ISTQB Glossary](https://glossary.istqb.org/en_US/search?term=Test%20Debt)
  - 摘要：未提取到可用摘要
  - 来源域名：glossary.istqb.org（HTTP 200）
- [Search | Atlassian](https://www.atlassian.com/search?query=Test%20Debt)
  - 摘要：Search the Atlassian website for product information and resources
  - 来源域名：www.atlassian.com（HTTP 200）
- [Search | Atlassian](https://www.atlassian.com/search?query=Test+Debt)
  - 摘要：Search the Atlassian website for product information and resources
  - 来源域名：www.atlassian.com（HTTP 200）
