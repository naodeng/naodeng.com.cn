---
title: "缺陷生命周期 ｜ Defect Lifecycle"
description: "缺陷生命周期（Defect Lifecycle）是流程一致性与可追踪性中的关键术语，主要用于定义缺陷从发现到关闭的状态流转规则与责任边界，帮助团队在软件测试与发布中做出更稳定的质量决策。"
section: "D"
related:
  - software-testing
  - test-strategy
...
<!-- TOC START -->
- [缺陷生命周期 ｜ Defect Lifecycle](#缺陷生命周期--defect-lifecycle)
- [关于缺陷生命周期的问题](#关于缺陷生命周期的问题)
  - [术语定义与适用边界](#术语定义与适用边界)
  - [方法框架与实施步骤](#方法框架与实施步骤)
  - [关键指标与口径说明](#关键指标与口径说明)
  - [工程落地建议](#工程落地建议)
...
缺陷生命周期（Defect Lifecycle）在软件测试语境里是“可执行方法”，不是“概念说明”。它的价值在于把质量决策结构化：谁提供证据、谁做判断、谁承担结果。
...
- [Medium（术语检索）](https://medium.com/search?q=Defect%20Lifecycle)
- [Wikipedia（术语检索）](https://zh.wikipedia.org/wiki/Special:Search?search=%E7%BC%BA%E9%99%B7%E7%94%9F%E5%91%BD%E5%91%A8%E6%9C%9F)
...
- [Test case - Wikipedia](https://en.wikipedia.org/wiki/Test_case)
  ...
  - 来源域名：en.wikipedia.org（HTTP 200）
- [ISTQB Glossary](https://glossary.istqb.org/en_US/search?term=Defect%20Lifecycle)
  - 摘要：未提取到可用摘要
  - 来源域名：glossary.istqb.org（HTTP 200）
- [Search | Atlassian](https://www.atlassian.com/search?query=Defect%20Lifecycle)
  - 摘要：Search the Atlassian website for product information and resources
  - 来源域名：www.atlassian.com（HTTP 200）
- [Search | Atlassian](https://www.atlassian.com/search?query=Defect+Lifecycle)
  - 摘要：Search the Atlassian website for product information and resources
  - 来源域名：www.atlassian.com（HTTP 200）
