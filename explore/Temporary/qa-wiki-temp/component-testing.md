---
title: "组件测试 ｜ Component Testing"
description: "组件测试（Component Testing）是中层质量保障中的关键术语，主要用于在组件级别验证逻辑和交互，介于单元与集成测试之间，帮助团队在软件测试与发布中做出更稳定的质量决策。"
section: "C"
related:
  - software-testing
  - test-strategy
...
<!-- TOC START -->
- [组件测试 ｜ Component Testing](#组件测试--component-testing)
- [关于组件测试的问题](#关于组件测试的问题)
  - [术语定义与适用边界](#术语定义与适用边界)
  - [方法框架与实施步骤](#方法框架与实施步骤)
  - [关键指标与口径说明](#关键指标与口径说明)
...
组件测试（Component Testing）在软件测试语境里是“可执行方法”，不是“概念说明”。它的价值在于把质量决策结构化：谁提供证据、谁做判断、谁承担结果。
...
- [单元测试 ｜ Unit Testing](/zh-cn/wiki/unit-testing/)
...
- [Medium（术语检索）](https://medium.com/search?q=Component%20Testing)
- [GitHub（术语检索）](https://github.com/search?q=Component%20Testing&type=repositories)
...
- [Test case - Wikipedia](https://en.wikipedia.org/wiki/Test_case)
  ...
  - 来源域名：en.wikipedia.org（HTTP 200）
- [ISTQB Glossary](https://glossary.istqb.org/en_US/search?term=Component%20Testing)
  - 摘要：未提取到可用摘要
  - 来源域名：glossary.istqb.org（HTTP 200）
- [Search | Atlassian](https://www.atlassian.com/search?query=Component%20Testing)
  - 摘要：Search the Atlassian website for product information and resources
  - 来源域名：www.atlassian.com（HTTP 200）
- [Search | Atlassian](https://www.atlassian.com/search?query=Component+Testing)
  - 摘要：Search the Atlassian website for product information and resources
  - 来源域名：www.atlassian.com（HTTP 200）
