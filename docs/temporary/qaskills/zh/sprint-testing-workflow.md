...
### macOS / Linux
```bash
SKILL_DIR="skills/skills-zh/testing-workflows/sprint-testing-workflow"
...
### Windows (PowerShell)
```powershell
$SkillDir = "skills/skills-zh/testing-workflows/sprint-testing-workflow"
...
## 来源
- 原始技能：[sprint-testing-workflow](https://github.com/naodeng/awesome-qa-skills/blob/main/skills/skills-zh/testing-workflows/sprint-testing-workflow)
