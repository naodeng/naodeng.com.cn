...
### macOS / Linux
```bash
SKILL_DIR="skills/skills-zh/testing-types/test-reporting"
...
### Windows (PowerShell)
```powershell
$SkillDir = "skills/skills-zh/testing-types/test-reporting"
...
## 来源
- 原始技能：[test-reporting](https://github.com/naodeng/awesome-qa-skills/blob/main/skills/skills-zh/testing-types/test-reporting)
