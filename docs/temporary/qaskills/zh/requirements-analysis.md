...
### macOS / Linux
```bash
SKILL_DIR="skills/skills-zh/testing-types/requirements-analysis"
...
### Windows (PowerShell)
```powershell
$SkillDir = "skills/skills-zh/testing-types/requirements-analysis"
...
## 来源
- 原始技能：[requirements-analysis](https://github.com/naodeng/awesome-qa-skills/blob/main/skills/skills-zh/testing-types/requirements-analysis)
