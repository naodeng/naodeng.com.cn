...
### macOS / Linux
```bash
SKILL_DIR="skills/skills-zh/testing-types/automation-testing"
...
### Windows (PowerShell)
```powershell
$SkillDir = "skills/skills-zh/testing-types/automation-testing"
...
## 来源
- 原始技能：[automation-testing](https://github.com/naodeng/awesome-qa-skills/blob/main/skills/skills-zh/testing-types/automation-testing)
