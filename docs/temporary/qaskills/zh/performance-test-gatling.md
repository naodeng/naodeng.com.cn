...
### macOS / Linux
```bash
SKILL_DIR="explore/skills-zh/performance-test-gatling"
...
### Windows (PowerShell)
```powershell
$SkillDir = "explore/skills-zh/performance-test-gatling"
...
## 来源
- 原始技能：[performance-test-gatling](https://github.com/naodeng/awesome-qa-skills/blob/main/explore/skills-zh/performance-test-gatling/SKILL.md)
