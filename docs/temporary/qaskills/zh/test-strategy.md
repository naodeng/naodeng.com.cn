...
### macOS / Linux
```bash
SKILL_DIR="skills/skills-zh/testing-types/test-strategy"
...
### Windows (PowerShell)
```powershell
$SkillDir = "skills/skills-zh/testing-types/test-strategy"
...
## 来源
- 原始技能：[test-strategy](https://github.com/naodeng/awesome-qa-skills/blob/main/skills/skills-zh/testing-types/test-strategy)
