...
### macOS / Linux
```bash
SKILL_DIR="skills/skills-zh/testing-types/api-testing"
...
### Windows (PowerShell)
```powershell
$SkillDir = "skills/skills-zh/testing-types/api-testing"
...
## 来源
- 原始技能：[api-testing](https://github.com/naodeng/awesome-qa-skills/blob/main/skills/skills-zh/testing-types/api-testing)
