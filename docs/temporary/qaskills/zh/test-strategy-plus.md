...
### macOS / Linux
```bash
SKILL_DIR="explore/skills-zh/test-strategy-plus"
...
### Windows (PowerShell)
```powershell
$SkillDir = "explore/skills-zh/test-strategy-plus"
...
## 来源
- 原始技能：[test-strategy-plus](https://github.com/naodeng/awesome-qa-skills/blob/main/explore/skills-zh/test-strategy-plus/SKILL.md)
