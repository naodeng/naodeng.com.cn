...
### macOS / Linux
```bash
SKILL_DIR="skills/skills-zh/testing-types/accessibility-testing"
...
### Windows (PowerShell)
```powershell
$SkillDir = "skills/skills-zh/testing-types/accessibility-testing"
...
## 来源
- 原始技能：[accessibility-testing](https://github.com/naodeng/awesome-qa-skills/blob/main/skills/skills-zh/testing-types/accessibility-testing)
