...
### macOS / Linux
```bash
SKILL_DIR="skills/skills-zh/testing-types/test-case-writing"
...
### Windows (PowerShell)
```powershell
$SkillDir = "skills/skills-zh/testing-types/test-case-writing"
...
## 来源
- 原始技能：[test-case-writing](https://github.com/naodeng/awesome-qa-skills/blob/main/skills/skills-zh/testing-types/test-case-writing)
