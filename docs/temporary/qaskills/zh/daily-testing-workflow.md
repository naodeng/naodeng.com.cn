...
### macOS / Linux
```bash
SKILL_DIR="skills/skills-zh/testing-workflows/daily-testing-workflow"
...
### Windows (PowerShell)
```powershell
$SkillDir = "skills/skills-zh/testing-workflows/daily-testing-workflow"
...
## 来源
- 原始技能：[daily-testing-workflow](https://github.com/naodeng/awesome-qa-skills/blob/main/skills/skills-zh/testing-workflows/daily-testing-workflow)
