...
### macOS / Linux
```bash
SKILL_DIR="skills/skills-zh/testing-types/mobile-testing"
...
### Windows (PowerShell)
```powershell
$SkillDir = "skills/skills-zh/testing-types/mobile-testing"
...
## 来源
- 原始技能：[mobile-testing](https://github.com/naodeng/awesome-qa-skills/blob/main/skills/skills-zh/testing-types/mobile-testing)
