...
### macOS / Linux
```bash
SKILL_DIR="skills/skills-zh/testing-types/bug-reporting"
...
### Windows (PowerShell)
```powershell
$SkillDir = "skills/skills-zh/testing-types/bug-reporting"
...
## 来源
- 原始技能：[bug-reporting](https://github.com/naodeng/awesome-qa-skills/blob/main/skills/skills-zh/testing-types/bug-reporting)
