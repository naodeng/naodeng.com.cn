...
## When
- When features involve permissions, sensitive data, or session control.
- Before release to perform focused security risk reduction.
- When suspicious attack signals appear and validation must be expanded quickly.

## What
- Deliver a risk-prioritized security validation checklist.
- Clarify critical issues, impact scope, and remediation ownership.
- Produce auditable pre-release security conclusions.
...
### macOS / Linux
```bash
SKILL_DIR="skills/skills-en/testing-types/security-testing"
DEST="$HOME/.codex/skills/naodeng-security-testing"
TMP_DIR="$(mktemp -d)"
...
### Windows (PowerShell)
```powershell
$SkillDir = "skills/skills-en/testing-types/security-testing"
$Dest = "$env:USERPROFILE\\.codex\\skills\\naodeng-security-testing"
...
## Source
- Original Skill: [security-testing](https://github.com/naodeng/awesome-qa-skills/blob/main/skills/skills-en/testing-types/security-testing)
