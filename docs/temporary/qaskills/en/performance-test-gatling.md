...
## Overview
This skill helps QA teams handle performance-test-gatling tasks with practical steps and reusable outputs.
...
## Skill Card
- Skill Name: performance-test-gatling
- Display Name: performance-test-gatling
- Language: English
- Last Synced: 2026-03-24

## Source
- Original Skill: [performance-test-gatling](|)
