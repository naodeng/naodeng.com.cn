...
## When
- After UI/component updates to ensure accessibility does not regress.
- When product scope requires stronger inclusive access compliance.
- Before release when auditable accessibility evidence is needed.

## What
- Deliver prioritized accessibility defects with fix guidance.
- Verify keyboard flow, semantic structure, and screen-reader usability.
- Preserve release-level accessibility evidence.
...
### macOS / Linux
```bash
SKILL_DIR="skills/skills-en/testing-types/accessibility-testing"
DEST="$HOME/.codex/skills/naodeng-accessibility-testing"
TMP_DIR="$(mktemp -d)"
...
### Windows (PowerShell)
```powershell
$SkillDir = "skills/skills-en/testing-types/accessibility-testing"
$Dest = "$env:USERPROFILE\\.codex\\skills\\naodeng-accessibility-testing"
...
## Source
- Original Skill: [accessibility-testing](https://github.com/naodeng/awesome-qa-skills/blob/main/skills/skills-en/testing-types/accessibility-testing)
