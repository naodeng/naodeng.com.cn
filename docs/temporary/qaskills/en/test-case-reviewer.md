...
### macOS / Linux
```bash
SKILL_DIR="skills/skills-en/testing-types/test-case-reviewer"
...
### Windows (PowerShell)
```powershell
$SkillDir = "skills/skills-en/testing-types/test-case-reviewer"
...
## Source
- Original Skill: [test-case-reviewer](https://github.com/naodeng/awesome-qa-skills/blob/main/skills/skills-en/testing-types/test-case-reviewer)
