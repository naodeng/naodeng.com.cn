...
## When
- When testing needs to move from ad-hoc execution to reusable process.
- When quality conclusions differ and a unified standard is needed.
- Before release when evidence-based decisions are mandatory.

## What
- Deliver executable plan, evidence record, and decision-ready summary.
- Clarify risk priorities and follow-up actions.
- Produce reusable templates for future cycles.
...
### macOS / Linux
```bash
SKILL_DIR="skills/skills-en/testing-types/ai-assisted-testing"
DEST="$HOME/.codex/skills/naodeng-ai-assisted-testing"
TMP_DIR="$(mktemp -d)"
...
### Windows (PowerShell)
```powershell
$SkillDir = "skills/skills-en/testing-types/ai-assisted-testing"
$Dest = "$env:USERPROFILE\\.codex\\skills\\naodeng-ai-assisted-testing"
...
## Source
- Original Skill: [ai-assisted-testing](https://github.com/naodeng/awesome-qa-skills/blob/main/skills/skills-en/testing-types/ai-assisted-testing)
