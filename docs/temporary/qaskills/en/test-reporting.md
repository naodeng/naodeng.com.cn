...
### macOS / Linux
```bash
SKILL_DIR="skills/skills-en/testing-types/test-reporting"
DEST="$HOME/.codex/skills/naodeng-test-reporting"
TMP_DIR="$(mktemp -d)"
...
### Windows (PowerShell)
```powershell
$SkillDir = "skills/skills-en/testing-types/test-reporting"
$Dest = "$env:USERPROFILE\\.codex\\skills\\naodeng-test-reporting"
...
## Source
- Original Skill: [test-reporting](https://github.com/naodeng/awesome-qa-skills/blob/main/skills/skills-en/testing-types/test-reporting)
