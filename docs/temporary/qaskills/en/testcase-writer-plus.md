...
### macOS / Linux
```bash
SKILL_DIR="explore/skills-en/testcase-writer-plus"
...
### Windows (PowerShell)
```powershell
$SkillDir = "explore/skills-en/testcase-writer-plus"
...
## Source
- Original Skill: [testcase-writer-plus](https://github.com/naodeng/awesome-qa-skills/blob/main/explore/skills-en/testcase-writer-plus/SKILL.md)
