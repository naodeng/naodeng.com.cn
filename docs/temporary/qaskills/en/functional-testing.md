...
### macOS / Linux
```bash
SKILL_DIR="skills/skills-en/testing-types/functional-testing"
DEST="$HOME/.codex/skills/naodeng-functional-testing"
TMP_DIR="$(mktemp -d)"
...
### Windows (PowerShell)
```powershell
$SkillDir = "skills/skills-en/testing-types/functional-testing"
$Dest = "$env:USERPROFILE\\.codex\\skills\\naodeng-functional-testing"
...
## Source
- Original Skill: [functional-testing](https://github.com/naodeng/awesome-qa-skills/blob/main/skills/skills-en/testing-types/functional-testing)
