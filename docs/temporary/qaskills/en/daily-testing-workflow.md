...
### macOS / Linux
```bash
SKILL_DIR="skills/skills-en/testing-workflows/daily-testing-workflow"
DEST="$HOME/.codex/skills/naodeng-daily-testing-workflow"
TMP_DIR="$(mktemp -d)"
...
### Windows (PowerShell)
```powershell
$SkillDir = "skills/skills-en/testing-workflows/daily-testing-workflow"
$Dest = "$env:USERPROFILE\\.codex\\skills\\naodeng-daily-testing-workflow"
...
## Source
- Original Skill: [daily-testing-workflow](https://github.com/naodeng/awesome-qa-skills/blob/main/skills/skills-en/testing-workflows/daily-testing-workflow)
