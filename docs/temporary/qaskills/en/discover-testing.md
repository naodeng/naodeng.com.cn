...
### macOS / Linux
```bash
SKILL_DIR="skills/skills-en/testing-workflows/discover-testing"
...
### Windows (PowerShell)
```powershell
$SkillDir = "skills/skills-en/testing-workflows/discover-testing"
...
## Source
- Original Skill: [discover-testing](https://github.com/naodeng/awesome-qa-skills/blob/main/skills/skills-en/testing-workflows/discover-testing)
