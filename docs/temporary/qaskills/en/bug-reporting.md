...
### macOS / Linux
```bash
SKILL_DIR="skills/skills-en/testing-types/bug-reporting"
DEST="$HOME/.codex/skills/naodeng-bug-reporting"
TMP_DIR="$(mktemp -d)"
...
### Windows (PowerShell)
```powershell
$SkillDir = "skills/skills-en/testing-types/bug-reporting"
$Dest = "$env:USERPROFILE\\.codex\\skills\\naodeng-bug-reporting"
...
## Source
- Original Skill: [bug-reporting](https://github.com/naodeng/awesome-qa-skills/blob/main/skills/skills-en/testing-types/bug-reporting)
