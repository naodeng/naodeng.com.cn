...
## Overview
This skill helps QA teams handle manual-testing tasks with practical steps and reusable outputs.

## Output Preview
- Clear task breakdown for manual-testing
...
## Source
- Original Skill: [manual-testing](|)
- Repository: [https://github.com/naodeng/awesome-qa-skills](https://github.com/naodeng/awesome-qa-skills)

## One-Click Install
npx @skill-hub/cli install manual-testing
