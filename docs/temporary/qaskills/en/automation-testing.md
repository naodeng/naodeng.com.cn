...
## Overview
This skill helps QA teams handle automation-testing tasks with practical steps and reusable outputs.

## Output Preview
- Clear task breakdown for automation-testing
...
## Source
- Original Skill: [automation-testing](|)
- Repository: [https://github.com/naodeng/awesome-qa-skills](https://github.com/naodeng/awesome-qa-skills)

## One-Click Install
npx @skill-hub/cli install automation-testing
