...
### macOS / Linux
```bash
SKILL_DIR="skills/skills-en/testing-types/automation-testing"
DEST="$HOME/.codex/skills/naodeng-automation-testing"
TMP_DIR="$(mktemp -d)"
...
### Windows (PowerShell)
```powershell
$SkillDir = "skills/skills-en/testing-types/automation-testing"
$Dest = "$env:USERPROFILE\\.codex\\skills\\naodeng-automation-testing"
...
## Source
- Original Skill: [automation-testing](https://github.com/naodeng/awesome-qa-skills/blob/main/skills/skills-en/testing-types/automation-testing)
