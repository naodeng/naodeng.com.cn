...
### macOS / Linux
```bash
SKILL_DIR="explore/skills-en/api-test-supertest"
...
### Windows (PowerShell)
```powershell
$SkillDir = "explore/skills-en/api-test-supertest"
...
## Source
- Original Skill: [api-test-supertest](https://github.com/naodeng/awesome-qa-skills/blob/main/explore/skills-en/api-test-supertest/SKILL.md)
