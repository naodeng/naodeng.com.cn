---
title: "冒烟检查自动化 ｜ Smoke Check Automation"
description: "冒烟检查自动化（Smoke Check Automation）是构建健康探测中的关键术语，主要用于对关键主流程做快速自动检查，确认构建可继续深入测试，帮助团队在软件测试与发布中做出更稳定的质量决策。"
section: "S"
related:
  - software-testing
  - test-strategy
...
order: 33
---
# 冒烟检查自动化 ｜ Smoke Check Automation

<!-- TOC START -->
- [冒烟检查自动化 ｜ Smoke Check Automation](#冒烟检查自动化--smoke-check-automation)
- [关于冒烟检查自动化的问题](#关于冒烟检查自动化的问题)
  - [术语定义与适用边界](#术语定义与适用边界)
  - [方法框架与实施步骤](#方法框架与实施步骤)
  - [关键指标与口径说明](#关键指标与口径说明)
  - [工程落地建议](#工程落地建议)
...
冒烟检查自动化（Smoke Check Automation）在软件测试语境里是“可执行方法”，不是“概念说明”。它的价值在于把质量决策结构化：谁提供证据、谁做判断、谁承担结果。
...
- [Medium（术语检索）](https://medium.com/search?q=Smoke%20Check%20Automation)
...
- [Test case - Wikipedia](https://en.wikipedia.org/wiki/Test_case)
  ...
  - 来源域名：en.wikipedia.org（HTTP 200）
- [ISTQB Glossary](https://glossary.istqb.org/en_US/search?term=Smoke%20Check%20Automation)
  - 摘要：未提取到可用摘要
  - 来源域名：glossary.istqb.org（HTTP 200）
- [Search | Atlassian](https://www.atlassian.com/search?query=Smoke%20Check%20Automation)
  - 摘要：Search the Atlassian website for product information and resources
  - 来源域名：www.atlassian.com（HTTP 200）
- [Search | Atlassian](https://www.atlassian.com/search?query=Smoke+Check+Automation)
  - 摘要：Search the Atlassian website for product information and resources
  - 来源域名：www.atlassian.com（HTTP 200）
