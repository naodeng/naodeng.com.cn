...
description: "契约测试（Contract Testing）是接口变更风险控制中的关键术语，主要用于验证服务提供者与消费者之间的接口契约一致性，帮助团队在软件测试与发布中做出更稳定的质量决策。"
section: "C"
related:
  - software-testing
  - test-strategy
...
契约测试（Contract Testing）在软件测试语境里是“可执行方法”，不是“概念说明”。它的价值在于把质量决策结构化：谁提供证据、谁做判断、谁承担结果。
...
- [API 测试 ｜ API Testing](/zh-cn/wiki/api-testing/)
...
- [Medium（术语检索）](https://medium.com/search?q=Contract%20Testing)
- [GitHub（术语检索）](https://github.com/search?q=Contract%20Testing&type=repositories)
...
- [Test case - Wikipedia](https://en.wikipedia.org/wiki/Test_case)
  ...
  - 来源域名：en.wikipedia.org（HTTP 200）
- [ISTQB Glossary](https://glossary.istqb.org/en_US/search?term=Contract%20Testing)
  - 摘要：未提取到可用摘要
  - 来源域名：glossary.istqb.org（HTTP 200）
- [Search | Atlassian](https://www.atlassian.com/search?query=Contract%20Testing)
  - 摘要：Search the Atlassian website for product information and resources
  - 来源域名：www.atlassian.com（HTTP 200）
- [Search | Atlassian](https://www.atlassian.com/search?query=Contract+Testing)
  - 摘要：Search the Atlassian website for product information and resources
  - 来源域名：www.atlassian.com（HTTP 200）
