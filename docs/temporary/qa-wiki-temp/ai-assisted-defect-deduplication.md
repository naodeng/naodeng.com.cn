---
title: "AI辅助缺陷去重 ｜ AI-assisted Defect Deduplication"
description: "AI辅助缺陷去重（AI-assisted Defect Deduplication）是缺陷库清洁度中的关键术语，主要用于借助语义匹配识别重复缺陷，减少重复提单和重复修复，帮助团队在软件测试与发布中做出更稳定的质量决策。"
section: "A"
related:
  - software-testing
  - test-strategy
...
order: 28
---
# AI辅助缺陷去重 ｜ AI-assisted Defect Deduplication

<!-- TOC START -->
- [AI辅助缺陷去重 ｜ AI-assisted Defect Deduplication](#ai辅助缺陷去重--ai-assisted-defect-deduplication)
- [关于AI辅助缺陷去重的问题](#关于AI辅助缺陷去重的问题)
  - [术语定义与适用边界](#术语定义与适用边界)
  - [方法框架与实施步骤](#方法框架与实施步骤)
  - [关键指标与口径说明](#关键指标与口径说明)
  - [工程落地建议](#工程落地建议)
...
AI辅助缺陷去重（AI-assisted Defect Deduplication）在软件测试语境里是“可执行方法”，不是“概念说明”。它的价值在于把质量决策结构化：谁提供证据、谁做判断、谁承担结果。
...
- [Medium（术语检索）](https://medium.com/search?q=AI-assisted%20Defect%20Deduplication)
- [GitHub（术语检索）](https://github.com/search?q=AI-assisted%20Defect%20Deduplication&type=repositories)
...
- [Test case - Wikipedia](https://en.wikipedia.org/wiki/Test_case)
  ...
  - 来源域名：en.wikipedia.org（HTTP 200）
- [ISTQB Glossary](https://glossary.istqb.org/en_US/search?term=AI-assisted%20Defect%20Deduplication)
  - 摘要：未提取到可用摘要
  - 来源域名：glossary.istqb.org（HTTP 200）
- [A global community of practice for software testing, quality | Ministry of Testing](https://www.ministryoftesting.com/search?query=AI-assisted%20Defect%20Deduplication)
...
- [A global community of practice for software testing, quality | Ministry of Testing](https://www.ministryoftesting.com/search?query=AI-assisted+Defect+Deduplication)
  - 摘要：Join the Ministry of Testing community - a great place to learn all things testing and quality engineering, connect with like minded people interested in software quality, and contribute to the advancement of the softwar...
  - 来源域名：www.ministryoftesting.com（HTTP 200）
