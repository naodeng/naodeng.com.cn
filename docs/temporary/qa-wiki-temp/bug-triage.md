---
title: "缺陷分流 ｜ Bug Triage"
description: "缺陷分流（Bug Triage）是缺陷治理效率中的关键术语，主要用于对缺陷进行优先级、严重度、责任归属和修复节奏的协同决策，帮助团队在软件测试与发布中做出更稳定的质量决策。"
section: "B"
related:
  - software-testing
  - test-strategy
...
<!-- TOC START -->
- [缺陷分流 ｜ Bug Triage](#缺陷分流--bug-triage)
- [关于缺陷分流的问题](#关于缺陷分流的问题)
  - [术语定义与适用边界](#术语定义与适用边界)
  - [方法框架与实施步骤](#方法框架与实施步骤)
  - [关键指标与口径说明](#关键指标与口径说明)
...
缺陷分流（Bug Triage）在软件测试语境里是“可执行方法”，不是“概念说明”。它的价值在于把质量决策结构化：谁提供证据、谁做判断、谁承担结果。
...
- [Medium（术语检索）](https://medium.com/search?q=Bug%20Triage)
- [Wikipedia（术语检索）](https://zh.wikipedia.org/wiki/Special:Search?search=%E7%BC%BA%E9%99%B7%E5%88%86%E6%B5%81)
...
- [Change control - Wikipedia](https://en.wikipedia.org/wiki/Change_control)
  - 摘要：Within quality management systems (QMS) and information technology (IT) systems, change control is a process—either formal or informal &#91; 1 &#93; —used to ensure that changes to a product or system are introduced in a...
...
- [Defect tracking - Wikipedia](https://en.wikipedia.org/wiki/Defect_tracking)
  ...
  - 来源域名：en.wikipedia.org（HTTP 200）
- [Issue tracking system - Wikipedia](https://en.wikipedia.org/wiki/Issue_tracking_system)
  - 摘要：An issue tracking system (also ITS , trouble ticket system , support ticket , request management or incident ticket system ) is a computer software package that manages and maintains lists of issues . &#91; 1 &#93; Issue...
  - 来源域名：en.wikipedia.org（HTTP 200）
...
- [Software testing - Wikipedia](https://en.wikipedia.org/wiki/Software_testing)
  - 摘要：未提取到可用摘要
  - 来源域名：en.wikipedia.org（HTTP 200）
- [ISTQB Glossary](https://glossary.istqb.org/en_US/search?term=defect)
  - 摘要：未提取到可用摘要
  - 来源域名：glossary.istqb.org（HTTP 200）
- [ISTQB Glossary](https://glossary.istqb.org/en_US/search?term=priority)
  - 摘要：未提取到可用摘要
  - 来源域名：glossary.istqb.org（HTTP 200）
- [ISTQB Glossary](https://glossary.istqb.org/en_US/search?term=severity)
  - 摘要：未提取到可用摘要
  - 来源域名：glossary.istqb.org（HTTP 200）
- [Bug Triage: Definition, Examples, and Best Practices | Atlassian | Atlassian](https://www.atlassian.com/agile/software-development/bug-triage)
  - 摘要：Learn the essentials of bug triage, from identification to resolution, and best practices for effective bug management in software development.<br/><br/>
