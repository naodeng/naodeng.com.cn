...
**Spec:** `docs/archive/qaskills/2026-08-05-qaskills-pages-redesign-design.md`
...
```bash
git add tests/e2e/specs/qaskills.spec.ts docs/archive/qaskills/2026-08-05-qaskills-pages-redesign-design.md
git commit -m "$(cat <<'EOF'
