...
**Spec:** `docs/archive/qaskills/2026-08-06-qaskills-lifecycle-path-design.md`
...
In `docs/archive/qaskills/2026-08-06-qaskills-lifecycle-path-design.md`, change status line to:
