...
- [prompts/regression-test-selection.md](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/regression-test-selection/prompts/regression-test-selection.md)
- [Open the Regression Test Selection source directory](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/regression-test-selection)
