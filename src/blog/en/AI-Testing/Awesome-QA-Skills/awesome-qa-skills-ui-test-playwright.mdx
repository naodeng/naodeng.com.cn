---
title: "Playwright UI Automation Testing: Build reliable regression with stable locators and controlled data"
...
```bash
npx skills add https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/ui-test-playwright -g
```
...
- Test scenario context example:[https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/ui-test-playwright/examples/sample-context.md](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/ui-test-playwright/examples/sample-context.md)
- Playwright UI Testing (EN) supporting references:[https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/ui-test-playwright/references/framework-spec.md](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/ui-test-playwright/references/framework-spec.md)
- Playwright UI Testing (EN) helper script: run-tests.sh:[https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/ui-test-playwright/scripts/run-tests.sh](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/ui-test-playwright/scripts/run-tests.sh)
- Awesome QA Skills: Playwright UI Testing (EN) Skill source:[https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/ui-test-playwright](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/ui-test-playwright)
- Playwright UI Testing Skill details:[https://inaodeng.com/en/qaskills/ui-test-playwright/](https://inaodeng.com/en/qaskills/ui-test-playwright/)
