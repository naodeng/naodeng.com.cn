---
title: "Test Report Review: Check whether conclusions, evidence, and release impact align"
...
A test report full of pass rates can still fail to support a release decision. When metric definitions differ, evidence links fail, or risk conclusions disconnect from failed runs, the report summarizes numbers without explaining the risk the team is accepting.

The Test Report Review Skill traces conclusions back to evidence: how metrics were calculated, whether failures entered the judgment, who accepts residual risk, and whether the recommendation exceeds what the material proves.

This guide shows how to review release-report metrics, evidence, risks, and recommendations so the report becomes decision input rather than ceremony.
...
```bash
npx skills add https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/test-report-review -g
```
...
- Awesome QA Skills: Test Report Review Skill source:[https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/test-report-review](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/test-report-review)
- Test Report Review Skill details:[https://inaodeng.com/en/qaskills/test-report-review/](https://inaodeng.com/en/qaskills/test-report-review/)
