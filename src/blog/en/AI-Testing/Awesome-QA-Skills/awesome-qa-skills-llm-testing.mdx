---
title: "LLM Testing: Systematically validate factual accuracy, refusal behavior, and safety boundaries"
...
## References
- LLM Testing prompt:[https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/llm-testing/prompts/llm-testing.md](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/llm-testing/prompts/llm-testing.md)
- Awesome QA Skills: LLM Testing Skill source:[https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/llm-testing](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/llm-testing)
- Awesome QA Skills on GitHub:[https://github.com/naodeng/awesome-qa-skills](https://github.com/naodeng/awesome-qa-skills)
- LLM Testing Skill details:[https://inaodeng.com/en/qaskills/llm-testing/](https://inaodeng.com/en/qaskills/llm-testing/)
