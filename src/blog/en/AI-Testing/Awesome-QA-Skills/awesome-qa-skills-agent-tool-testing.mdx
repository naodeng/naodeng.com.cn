---
title: "Agent Tool Testing: Verify an agent using order lookup, refund, and notification tools for parameter boundaries, authorization, idempotency, and side effects"
