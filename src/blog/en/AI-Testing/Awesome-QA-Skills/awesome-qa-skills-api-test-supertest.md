---
title: "Supertest API automation from definitions to CI"
...
A team needs a result it can hand off. Using “Generate a Supertest suite for a Node.js API with isolated app, data, and authentication state,” we can see which inputs and evidence API Test Supertest expects.
