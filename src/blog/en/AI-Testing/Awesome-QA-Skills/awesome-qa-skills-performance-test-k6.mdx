...
- [examples/seckill-sample.env](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/performance-test-k6/examples/seckill-sample.env)
- [references/framework-spec.md](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/performance-test-k6/references/framework-spec.md)
- [scripts/config.js](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/performance-test-k6/scripts/config.js)
- [Open the Performance Test k6 source directory](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/performance-test-k6)
