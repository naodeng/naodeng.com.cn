...
The source directory contains 1 references, 18 script entries. Start with [references/local](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/test-strategy/references/local), [scripts/batch_convert_templates.py](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/test-strategy/scripts/batch_convert_templates.py).

- [Open the Test Strategy source directory](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/test-strategy)
...
- [references/local](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/test-strategy/references/local)
- [scripts/batch_convert_templates.py](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/test-strategy/scripts/batch_convert_templates.py)
- [Open the Test Strategy source directory](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/test-strategy)
