...
Interpret a checkout load-test result across throughput, tail latency, error rate, resource use, and test validity. This kind of work often becomes a broad checklist with no ordering, evidence, or handoff. Performance Result Analysis brings the task back to scope, evidence, and the next action.

## Start with the source Skill

The complete execution contract lives in [prompts/performance-result-analysis.md](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/performance-result-analysis/prompts/performance-result-analysis.md). The source directory also contains 3 evaluation cases for checking whether an output follows the contract.
...
- [Open the Performance Result Analysis source directory](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/performance-result-analysis)
...
- [prompts/performance-result-analysis.md](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/performance-result-analysis/prompts/performance-result-analysis.md)
- [Open the Performance Result Analysis source directory](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/performance-result-analysis)
