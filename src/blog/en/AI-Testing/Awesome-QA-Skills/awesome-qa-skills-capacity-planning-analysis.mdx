...
Assess next-quarter order-service capacity from growth expectations, peak transactions, and resource curves. This kind of work often becomes a broad checklist with no ordering, evidence, or handoff. Capacity Planning Analysis brings the task back to scope, evidence, and the next action.
...
- [Open the Capacity Planning Analysis source directory](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/capacity-planning-analysis)
...
- [prompts/capacity-planning-analysis.md](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/capacity-planning-analysis/prompts/capacity-planning-analysis.md)
- [Open the Capacity Planning Analysis source directory](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/capacity-planning-analysis)
