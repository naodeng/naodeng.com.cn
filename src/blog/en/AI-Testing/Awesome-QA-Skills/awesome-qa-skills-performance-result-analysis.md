---
title: "Performance Result Analysis: from “Interpret a checkout load-test result across throughput, tail latency, error rate, resource use, and test validity” to a reviewable conclusion"
description: "Performance Result Analysis field guide covering project inputs, evidence, execution boundaries, advanced composition, and team gates."
date: 2026-09-14T09:00:00.000Z
author: "nao.deng"
tags: ["AI Testing", "Agent Skills", "Performance Result Analysis"]
categories: ["AI Testing", "QA Skills"]
series: ["Awesome QA Skills Field Guides"]
---

AI testing rarely loses time on one check alone. The slower part is turning requirements, logs, interfaces, and prior defects into a judgment the team can execute and review. A reusable Skill keeps that repeated analysis in one place, so testers spend less time rebuilding the same context and handoffs carry their evidence forward. Performance Result Analysis applies that approach to a concrete task: AI testing rarely loses time on one check alone. This guide starts with AI-testing workflow efficiency, then shows when to use the Skill, what to provide, and what it should produce.
...
The complete execution contract lives in [Performance Result Analysis prompt](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/performance-result-analysis/prompts/performance-result-analysis.md). The source directory also contains 3 evaluation cases for checking whether an output follows the contract.
