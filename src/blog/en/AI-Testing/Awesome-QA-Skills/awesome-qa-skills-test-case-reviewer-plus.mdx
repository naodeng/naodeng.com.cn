---
title: "Test Case Review Plus: Trace high-risk gaps across requirements, cases, and evidence"
...
Requirements say a refund must recover, the risk register marks duplicate charging P0, yet the existing cases cover only a successful refund. When several sources enter a review, the hard part is not finding one more issue. It is knowing which fact it conflicts with and which high-risk journey it affects.

The Test Case Reviewer Plus Skill retains sources, authority, and differences across that review. It compares requirements, risks, and existing cases item by item, so findings carry evidence and severity. When sources disagree, the conclusion marks the conflict instead of silently choosing the statement that looks more plausible.

Using order coverage review, this guide shows how to align sources, locate high-risk gaps, record conflicts, and make later revisions traceable to the original material.
...
```bash
npx skills add https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/test-case-reviewer-plus -g
```
...
- Analysis result example:[https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/test-case-reviewer-plus/examples/analysis-sample.md](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/test-case-reviewer-plus/examples/analysis-sample.md)
- Awesome QA Skills: test-case-reviewer-plus (EN) Skill source:[https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/test-case-reviewer-plus](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/test-case-reviewer-plus)
- Test Case Reviewer Plus Skill details:[https://inaodeng.com/en/qaskills/test-case-reviewer-plus/](https://inaodeng.com/en/qaskills/test-case-reviewer-plus/)
