...
The source directory contains 17 script entries. Start with [Template conversion script](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-workflows/daily-testing-workflow/scripts/batch_convert_templates.py).
...
```bash
npx skills add https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-workflows/daily-testing-workflow -g
```
...
- Daily Testing Workflow helper script: batch_convert_templates.py:[https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-workflows/daily-testing-workflow/scripts/batch_convert_templates.py](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-workflows/daily-testing-workflow/scripts/batch_convert_templates.py)
- Awesome QA Skills: Daily Testing Workflow Skill source:[https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-workflows/daily-testing-workflow](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-workflows/daily-testing-workflow)
- Daily Testing Workflow Skill details:[https://inaodeng.com/en/qaskills/daily-testing-workflow/](https://inaodeng.com/en/qaskills/daily-testing-workflow/)
