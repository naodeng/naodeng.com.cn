...
Review membership-upgrade acceptance criteria for ambiguity, missing states, unverifiable language, and conflicting rules. This kind of work often becomes a broad checklist with no ordering, evidence, or handoff. Acceptance Criteria Review brings the task back to scope, evidence, and the next action.

## Start with the source Skill

The complete execution contract lives in [prompts/acceptance-criteria-review.md](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/acceptance-criteria-review/prompts/acceptance-criteria-review.md). The source directory also contains 3 evaluation cases for checking whether an output follows the contract.
...
- [Open the Acceptance Criteria Review source directory](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/acceptance-criteria-review)
...
- [prompts/acceptance-criteria-review.md](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/acceptance-criteria-review/prompts/acceptance-criteria-review.md)
- [Open the Acceptance Criteria Review source directory](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/acceptance-criteria-review)
