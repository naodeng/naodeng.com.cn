---
title: "Acceptance Criteria Review: Review membership-upgrade acceptance criteria for ambiguity, missing states, unverifiable language, and conflicting rules"
