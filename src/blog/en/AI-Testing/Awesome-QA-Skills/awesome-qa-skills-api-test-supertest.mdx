...
- [Open the API Test Supertest source directory](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/api-test-supertest)
...
- [references/framework-spec.md](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/api-test-supertest/references/framework-spec.md)
- [scripts/__pycache__](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/api-test-supertest/scripts/__pycache__)
- [Open the API Test Supertest source directory](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/api-test-supertest)
