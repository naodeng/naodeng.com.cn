...
- [examples/bruno](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/api-test-supertest/examples/bruno)
...
- [api-test-supertest (EN) helper script: __pycache__](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/api-test-supertest/scripts/__pycache__)
