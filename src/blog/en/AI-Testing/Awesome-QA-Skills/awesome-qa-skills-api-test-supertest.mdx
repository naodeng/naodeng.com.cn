...
- Bruno testing example:[https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/api-test-supertest/examples/bruno](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/api-test-supertest/examples/bruno)
- api-test-supertest (EN) supporting references:[https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/api-test-supertest/references/framework-spec.md](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/api-test-supertest/references/framework-spec.md)
- Awesome QA Skills: api-test-supertest (EN) Skill source:[https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/api-test-supertest](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/api-test-supertest)
- API Test Supertest Skill details:[https://inaodeng.com/en/qaskills/api-test-supertest/](https://inaodeng.com/en/qaskills/api-test-supertest/)
