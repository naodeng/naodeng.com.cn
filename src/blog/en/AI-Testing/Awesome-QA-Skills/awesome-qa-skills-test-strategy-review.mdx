---
title: "Test Strategy Review: Review scope, risk, and release gates based on evidence"
...
```bash
npx skills add https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/test-strategy-review -g
```
...
- Awesome QA Skills: Test Strategy Review Skill source:[https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/test-strategy-review](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/test-strategy-review)
- Test Strategy Review Skill details:[https://inaodeng.com/en/qaskills/test-strategy-review/](https://inaodeng.com/en/qaskills/test-strategy-review/)
