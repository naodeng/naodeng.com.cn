...
```bash
npx skills add https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-workflows/discover-testing -g
```
...
- Testing Skill Discovery helper script: batch_convert_templates.py:[https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-workflows/discover-testing/scripts/batch_convert_templates.py](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-workflows/discover-testing/scripts/batch_convert_templates.py)
- Awesome QA Skills: Testing Skill Discovery Skill source:[https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-workflows/discover-testing](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-workflows/discover-testing)
- Testing Skill Discovery Skill details:[https://inaodeng.com/en/qaskills/discover-testing/](https://inaodeng.com/en/qaskills/discover-testing/)
