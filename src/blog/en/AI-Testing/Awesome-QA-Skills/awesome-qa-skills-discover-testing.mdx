...
The source directory contains 17 script entries. Start with [scripts/batch_convert_templates.py](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-workflows/discover-testing/scripts/batch_convert_templates.py).
