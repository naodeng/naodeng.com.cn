...
- [Open the Testing Skill Discovery source directory](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-workflows/discover-testing)
...
- [scripts/batch_convert_templates.py](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-workflows/discover-testing/scripts/batch_convert_templates.py)
- [Open the Testing Skill Discovery source directory](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-workflows/discover-testing)
