...
The source directory contains 1 references, 17 script entries. Start with [references/local](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/mobile-testing/references/local), [scripts/batch_convert_templates.py](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/mobile-testing/scripts/batch_convert_templates.py).

- [Open the Mobile Testing source directory](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/mobile-testing)
...
- [references/local](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/mobile-testing/references/local)
- [scripts/batch_convert_templates.py](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/mobile-testing/scripts/batch_convert_templates.py)
- [Open the Mobile Testing source directory](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/mobile-testing)
