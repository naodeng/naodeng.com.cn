---
title: "Mobile Testing: Cover weak networks, permissions, and app lifecycle scenarios"
...
- Mobile Testing supporting references:[https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/mobile-testing/references/local](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/mobile-testing/references/local)
- Mobile Testing helper script: batch_convert_templates.py:[https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/mobile-testing/scripts/batch_convert_templates.py](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/mobile-testing/scripts/batch_convert_templates.py)
- Awesome QA Skills: Mobile Testing Skill source:[https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/mobile-testing](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/mobile-testing)
- Mobile Testing Skill details:[https://inaodeng.com/en/qaskills/mobile-testing/](https://inaodeng.com/en/qaskills/mobile-testing/)
