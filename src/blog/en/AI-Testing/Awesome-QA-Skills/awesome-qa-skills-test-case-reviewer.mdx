---
title: "Test Case Review: Find coverage gaps, ambiguous assertions, and high-risk scenarios"
...
- Test Case Review helper script: batch_convert_templates.py:[https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/test-case-reviewer/scripts/batch_convert_templates.py](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/test-case-reviewer/scripts/batch_convert_templates.py)
- Awesome QA Skills: Test Case Review Skill source:[https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/test-case-reviewer](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/test-case-reviewer)
- Test Case Review Skill details:[https://inaodeng.com/en/qaskills/test-case-reviewer/](https://inaodeng.com/en/qaskills/test-case-reviewer/)
