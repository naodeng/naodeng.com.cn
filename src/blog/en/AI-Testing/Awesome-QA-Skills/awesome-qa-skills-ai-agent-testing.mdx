...
Evaluate a support agent for goal completion, planning, memory, tool use, recovery, and safety boundaries. This kind of work often becomes a broad checklist with no ordering, evidence, or handoff. AI Agent Testing brings the task back to scope, evidence, and the next action.

## Start with the source Skill

The complete execution contract lives in [prompts/ai-agent-testing.md](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/ai-agent-testing/prompts/ai-agent-testing.md). The source directory also contains 3 evaluation cases for checking whether an output follows the contract.
...
- [Open the AI Agent Testing source directory](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/ai-agent-testing)
...
- [prompts/ai-agent-testing.md](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/ai-agent-testing/prompts/ai-agent-testing.md)
- [Open the AI Agent Testing source directory](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/ai-agent-testing)
