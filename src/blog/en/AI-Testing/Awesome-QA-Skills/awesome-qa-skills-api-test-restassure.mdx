...
- [examples/bruno](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/api-test-restassure/examples/bruno)
...
- [api-test-restassure (EN) helper script: __pycache__](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/api-test-restassure/scripts/__pycache__)
