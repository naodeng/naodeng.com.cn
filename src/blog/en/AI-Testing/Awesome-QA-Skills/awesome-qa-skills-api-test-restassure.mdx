...
- Bruno testing example:[https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/api-test-restassure/examples/bruno](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/api-test-restassure/examples/bruno)
- api-test-restassure (EN) supporting references:[https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/api-test-restassure/references/framework-spec.md](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/api-test-restassure/references/framework-spec.md)
- Awesome QA Skills: api-test-restassure (EN) Skill source:[https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/api-test-restassure](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/api-test-restassure)
- API Test RestAssure Skill details:[https://inaodeng.com/en/qaskills/api-test-restassure/](https://inaodeng.com/en/qaskills/api-test-restassure/)
