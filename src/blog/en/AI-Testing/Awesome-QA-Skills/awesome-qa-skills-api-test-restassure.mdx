...
- [Open the API Test RestAssure source directory](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/api-test-restassure)
...
- [references/framework-spec.md](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/api-test-restassure/references/framework-spec.md)
- [scripts/__pycache__](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/api-test-restassure/scripts/__pycache__)
- [Open the API Test RestAssure source directory](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/api-test-restassure)
