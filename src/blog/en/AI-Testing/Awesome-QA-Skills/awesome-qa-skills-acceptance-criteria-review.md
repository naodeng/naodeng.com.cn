---
title: "Acceptance Criteria Review: from “Review membership-upgrade acceptance criteria for ambiguity, missing states, unverifiable language, and conflicting rules” to a reviewable conclusion"
description: "Acceptance Criteria Review field guide covering project inputs, evidence, execution boundaries, advanced composition, and team gates."
date: 2026-08-31T09:00:00.000Z
author: "nao.deng"
tags: ["AI Testing", "Agent Skills", "Acceptance Criteria Review"]
...
The complete execution contract lives in [Acceptance Criteria Review prompt](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/acceptance-criteria-review/prompts/acceptance-criteria-review.md). The source directory also contains 3 evaluation cases for checking whether an output follows the contract.
...
| --- | --- | --- |
| Goal and scope | Review membership-upgrade acceptance criteria for ambiguity, missing states, unverifiable language, and conflicting rules | Name journeys outside this pass |
...
| --- | --- | --- |
| Upstream to acceptance-criteria-review | Source versions, scope, risk, open items | Staleness and conflicts |
| acceptance-criteria-review to downstream | Judgments, evidence index, residual risk, tasks | Executability and ownership |
| Feedback to acceptance-criteria-review | Runs, defects, changed facts | Baseline and regression scope |
...
| --- | --- | --- |
| acceptance-criteria-review input | Version, environment, sources, and owner | Stop and list gaps |
| acceptance-criteria-review artifact | Material claims have basis, status, and impact | Return for evidence |
| acceptance-criteria-review execution | Command, query, or verification path is repeatable | Classify infrastructure or test issue |
| acceptance-criteria-review decision | Residual risk has an accepter and date | Do not enter the next stage |
...
## References
- [Acceptance Criteria Review prompt](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/acceptance-criteria-review/prompts/acceptance-criteria-review.md)
- [Awesome QA Skills: Acceptance Criteria Review Skill source](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/acceptance-criteria-review)
- [Awesome QA Skills on GitHub](https://github.com/naodeng/awesome-qa-skills)
- [Acceptance Criteria Review Skill details](https://inaodeng.com/en/qaskills/acceptance-criteria-review/)
