---
title: "Postman API Testing: Turn API definitions into sustainable CI regression"
...
- Test scenario context example:[https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/api-test-postman/examples/sample-context.md](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/api-test-postman/examples/sample-context.md)
- Postman API Testing (EN) supporting references:[https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/api-test-postman/references/framework-spec.md](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/api-test-postman/references/framework-spec.md)
- Postman API Testing (EN) helper script: run-tests.sh:[https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/api-test-postman/scripts/run-tests.sh](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/api-test-postman/scripts/run-tests.sh)
- Awesome QA Skills: Postman API Testing (EN) Skill source:[https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/api-test-postman](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/api-test-postman)
- Postman API Testing Skill details:[https://inaodeng.com/en/qaskills/api-test-postman/](https://inaodeng.com/en/qaskills/api-test-postman/)
