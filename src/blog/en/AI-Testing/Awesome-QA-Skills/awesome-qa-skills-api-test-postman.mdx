...
- [Open the Postman API Testing source directory](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/api-test-postman)
...
- [references/framework-spec.md](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/api-test-postman/references/framework-spec.md)
- [scripts/run-tests.sh](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/api-test-postman/scripts/run-tests.sh)
- [Open the Postman API Testing source directory](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/api-test-postman)
