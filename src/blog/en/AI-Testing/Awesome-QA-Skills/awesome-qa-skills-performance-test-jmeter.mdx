---
title: "JMeter Performance Testing: Turn real workload models into executable load-test scripts"
...
JMeter plans often become hard to reproduce because thread groups, CSV data, and listeners hide important assumptions. Being able to open a JMX file does not mean another person can trust its load meaning.

The JMeter Performance Testing Skill makes workload setup, test data, assertions, and result capture explicit so a shared plan survives handoff and CI.
...
```bash
npx skills add https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/performance-test-jmeter -g
```
...
- Test scenario context example:[https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/performance-test-jmeter/examples/sample-context.md](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/performance-test-jmeter/examples/sample-context.md)
- JMeter Performance Testing (EN) supporting references:[https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/performance-test-jmeter/references/framework-spec.md](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/performance-test-jmeter/references/framework-spec.md)
- JMeter Performance Testing (EN) helper script: run-tests.sh:[https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/performance-test-jmeter/scripts/run-tests.sh](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/performance-test-jmeter/scripts/run-tests.sh)
- Awesome QA Skills: JMeter Performance Testing (EN) Skill source:[https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/performance-test-jmeter](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/performance-test-jmeter)
- JMeter Performance Testing Skill details:[https://inaodeng.com/en/qaskills/performance-test-jmeter/](https://inaodeng.com/en/qaskills/performance-test-jmeter/)
