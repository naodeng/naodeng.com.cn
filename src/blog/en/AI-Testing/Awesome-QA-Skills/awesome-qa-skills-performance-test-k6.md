---
title: "k6 performance testing begins with the workload model"
...
A team needs a result it can hand off. Using “Model checkout load with k6, set latency and error thresholds, and correlate service metrics,” we can see which inputs and evidence Performance Test k6 expects.
