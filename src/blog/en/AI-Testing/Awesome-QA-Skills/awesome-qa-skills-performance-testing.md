---
title: "Replace “make it fast” with a workload and thresholds"
...
Turn checkout concurrency goals into a workload model, thresholds, monitoring, and stop conditions. The task sounds familiar, yet evidence and boundaries are easy to lose. Performance Testing starts there.
...
- [Performance Testing supporting references](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/performance-testing/references/local)
- [Performance Testing helper script: batch_convert_templates.py](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/performance-testing/scripts/batch_convert_templates.py)
- [Awesome QA Skills: Performance Testing Skill source](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/performance-testing)
- [Performance Testing Skill details](https://inaodeng.com/en/qaskills/performance-testing/)
