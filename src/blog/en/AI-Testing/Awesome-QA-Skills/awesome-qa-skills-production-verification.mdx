...
Verify core transactions, metrics, logs, alerts, and rollback conditions after an order-service release. This kind of work often becomes a broad checklist with no ordering, evidence, or handoff. Production Verification brings the task back to scope, evidence, and the next action.

## Start with the source Skill

The complete execution contract lives in [prompts/production-verification.md](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/production-verification/prompts/production-verification.md). The source directory also contains 3 evaluation cases for checking whether an output follows the contract.
...
- [Open the Production Verification source directory](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/production-verification)
...
- [prompts/production-verification.md](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/production-verification/prompts/production-verification.md)
- [Open the Production Verification source directory](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/production-verification)
