---
title: "WebdriverIO UI Automation Testing: Build reliable regression with stable locators and controlled data"
...
```bash
npx skills add https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/ui-test-webdriverio -g
```
...
- Test scenario context example:[https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/ui-test-webdriverio/examples/sample-context.md](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/ui-test-webdriverio/examples/sample-context.md)
- WebdriverIO UI Testing (EN) supporting references:[https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/ui-test-webdriverio/references/framework-spec.md](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/ui-test-webdriverio/references/framework-spec.md)
- WebdriverIO UI Testing (EN) helper script: run-tests.sh:[https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/ui-test-webdriverio/scripts/run-tests.sh](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/ui-test-webdriverio/scripts/run-tests.sh)
- Awesome QA Skills: WebdriverIO UI Testing (EN) Skill source:[https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/ui-test-webdriverio](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/ui-test-webdriverio)
- WebdriverIO UI Testing Skill details:[https://inaodeng.com/en/qaskills/ui-test-webdriverio/](https://inaodeng.com/en/qaskills/ui-test-webdriverio/)
