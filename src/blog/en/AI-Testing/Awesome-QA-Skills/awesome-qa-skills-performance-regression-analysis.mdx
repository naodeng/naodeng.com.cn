...
## References
- Performance Regression Analysis prompt:[https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/performance-regression-analysis/prompts/performance-regression-analysis.md](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/performance-regression-analysis/prompts/performance-regression-analysis.md)
- Awesome QA Skills: Performance Regression Analysis Skill source:[https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/performance-regression-analysis](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/performance-regression-analysis)
- Awesome QA Skills on GitHub:[https://github.com/naodeng/awesome-qa-skills](https://github.com/naodeng/awesome-qa-skills)
- Performance Regression Analysis Skill details:[https://inaodeng.com/en/qaskills/performance-regression-analysis/](https://inaodeng.com/en/qaskills/performance-regression-analysis/)
