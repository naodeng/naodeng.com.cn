...
Compare two checkout versions to decide whether a latency regression is real, how large it is, and whether it blocks release. This kind of work often becomes a broad checklist with no ordering, evidence, or handoff. Performance Regression Analysis brings the task back to scope, evidence, and the next action.

## Start with the source Skill

The complete execution contract lives in [prompts/performance-regression-analysis.md](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/performance-regression-analysis/prompts/performance-regression-analysis.md). The source directory also contains 3 evaluation cases for checking whether an output follows the contract.
...
- [Open the Performance Regression Analysis source directory](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/performance-regression-analysis)
...
- [prompts/performance-regression-analysis.md](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/performance-regression-analysis/prompts/performance-regression-analysis.md)
- [Open the Performance Regression Analysis source directory](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/performance-regression-analysis)
