---
title: "Performance Regression Analysis: Compare two checkout versions to decide whether a latency regression is real, how large it is, and whether it blocks release"
