...
- [Open the Bug Reporting source directory](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/bug-reporting)
...
- [references/local](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/bug-reporting/references/local)
- [scripts/batch_convert_templates.py](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/bug-reporting/scripts/batch_convert_templates.py)
- [Open the Bug Reporting source directory](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/bug-reporting)
