...
```bash
npx skills add https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/bug-reporting -g
```
...
- Bug Reporting supporting references:[https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/bug-reporting/references/local](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/bug-reporting/references/local)
- Bug Reporting helper script: batch_convert_templates.py:[https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/bug-reporting/scripts/batch_convert_templates.py](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/bug-reporting/scripts/batch_convert_templates.py)
- Awesome QA Skills: Bug Reporting Skill source:[https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/bug-reporting](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/bug-reporting)
- Bug Reporting Skill details:[https://inaodeng.com/en/qaskills/bug-reporting/](https://inaodeng.com/en/qaskills/bug-reporting/)
