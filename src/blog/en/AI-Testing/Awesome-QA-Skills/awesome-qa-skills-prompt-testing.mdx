...
Test an order-assistant prompt for instruction following, factual citation, boundary refusal, multi-turn consistency, and version regression. This kind of work often becomes a broad checklist with no ordering, evidence, or handoff. Prompt Testing brings the task back to scope, evidence, and the next action.

## Start with the source Skill

The complete execution contract lives in [prompts/prompt-testing.md](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/prompt-testing/prompts/prompt-testing.md). The source directory also contains 3 evaluation cases for checking whether an output follows the contract.
...
- [Open the Prompt Testing source directory](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/prompt-testing)
...
- [prompts/prompt-testing.md](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/prompt-testing/prompts/prompt-testing.md)
- [Open the Prompt Testing source directory](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/prompt-testing)
