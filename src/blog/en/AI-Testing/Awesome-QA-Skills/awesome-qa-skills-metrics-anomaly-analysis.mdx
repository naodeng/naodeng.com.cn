---
title: "Metrics Anomaly Analysis: Investigate checkout-success and latency anomalies by validating the window, metric definition, impact scope, and candidate causes"
