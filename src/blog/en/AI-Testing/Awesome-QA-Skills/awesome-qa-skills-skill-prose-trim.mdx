...
```bash
npx skills add https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/skill-engineering/skill-prose-trim -g
```
...
- Awesome QA Skills: Process Prose Trimming Skill source:[https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/skill-engineering/skill-prose-trim](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/skill-engineering/skill-prose-trim)
- Process Prose Trimming Skill details:[https://inaodeng.com/en/qaskills/skill-prose-trim/](https://inaodeng.com/en/qaskills/skill-prose-trim/)
