...
Use a failed checkout trace to locate latency and error propagation across gateway, order, payment, and notification services. This kind of work often becomes a broad checklist with no ordering, evidence, or handoff. Distributed Trace Analysis brings the task back to scope, evidence, and the next action.

## Start with the source Skill

The complete execution contract lives in [prompts/distributed-trace-analysis.md](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/distributed-trace-analysis/prompts/distributed-trace-analysis.md). The source directory also contains 3 evaluation cases for checking whether an output follows the contract.
...
- [Open the Distributed Trace Analysis source directory](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/distributed-trace-analysis)
...
- [prompts/distributed-trace-analysis.md](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/distributed-trace-analysis/prompts/distributed-trace-analysis.md)
- [Open the Distributed Trace Analysis source directory](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/en/testing-types/distributed-trace-analysis)
