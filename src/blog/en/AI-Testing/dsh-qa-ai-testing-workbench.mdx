...
<img class="article-content-image" src="/images/dsh-qa-v1.webp" width="1600" height="979" loading="eager" fetchpriority="high" decoding="async" alt="dsh-qa QA Workbench showing the project dashboard, kanban, and testing materials" />
...
For the record-by-record walkthrough, continue with [From Requirements to Release: Running a Full Test Project with dsh-qa](/en/blog/ai-testing/dsh-qa-test-project-full-lifecycle/).
