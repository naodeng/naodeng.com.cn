---
title: "生产验证：从“在订单服务发布后验证核心交易、指标、日志、告警与回滚条件是否符合预期”到可复核结论"
...
在订单服务发布后验证核心交易、指标、日志、告警与回滚条件是否符合预期。这类任务很容易被写成一张泛泛的检查表，最后没人知道应该先做什么，也没法复核结论。生产验证 的入口约束把重点拉回证据、范围和下一步动作。

## 先回到源 Skill

这个 Skill 的完整执行规则在 [prompts/production-verification.md](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/zh/testing-types/production-verification/prompts/production-verification.md)。源目录还包含 3 个评测用例，用于验证输出是否遵守契约。
...
- [打开 生产验证 源目录](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/zh/testing-types/production-verification)
...
- [prompts/production-verification.md](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/zh/testing-types/production-verification/prompts/production-verification.md)
- [打开 生产验证 源目录](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/zh/testing-types/production-verification)
