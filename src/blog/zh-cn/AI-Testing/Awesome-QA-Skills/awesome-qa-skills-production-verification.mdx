---
title: "生产验证 Skill：要对齐业务信号，发布完成才有后续证据"
...
- [生产事故分析](https://inaodeng.com/zh-cn/qaskills/production-incident-analysis/)：理解验证动作要覆盖的风险来源。
- [测试报告](https://inaodeng.com/zh-cn/qaskills/test-reporting/)：固定命令、结果、时间窗口和证据边界。
- [QA 质量视角](https://inaodeng.com/zh-cn/qaskills/qa-quality-perspective/)：把线上信号接回发布结论。
