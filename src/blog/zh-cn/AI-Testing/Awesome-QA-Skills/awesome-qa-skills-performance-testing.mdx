...
The performance-testing skill turns expected usage into workload, success criteria, and evidence, connecting system behavior to a user-facing service promise.
