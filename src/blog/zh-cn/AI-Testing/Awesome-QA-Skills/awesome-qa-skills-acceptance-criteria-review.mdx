---
title: "验收标准评审：从“审阅会员升级验收标准，找出歧义、缺失状态、不可验证的描述和业务规则冲突”到可复核结论"
...
审阅会员升级验收标准，找出歧义、缺失状态、不可验证的描述和业务规则冲突。这类任务很容易被写成一张泛泛的检查表，最后没人知道应该先做什么，也没法复核结论。验收标准评审 的入口约束把重点拉回证据、范围和下一步动作。

## 先回到源 Skill

这个 Skill 的完整执行规则在 [prompts/acceptance-criteria-review.md](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/zh/testing-types/acceptance-criteria-review/prompts/acceptance-criteria-review.md)。源目录还包含 3 个评测用例，用于验证输出是否遵守契约。
...
- [打开 验收标准评审 源目录](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/zh/testing-types/acceptance-criteria-review)
...
- [prompts/acceptance-criteria-review.md](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/zh/testing-types/acceptance-criteria-review/prompts/acceptance-criteria-review.md)
- [打开 验收标准评审 源目录](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/zh/testing-types/acceptance-criteria-review)
