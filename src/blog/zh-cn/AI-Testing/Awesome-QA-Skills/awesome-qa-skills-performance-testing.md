...
源目录现有 1 份示例、2 份参考、17 个脚本入口。可以先看 [k6 负载测试示例](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/zh/testing-types/performance-testing/examples/k6-load-testing)、[性能测试 补充参考资料](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/zh/testing-types/performance-testing/references/local)、[模板批量转换脚本](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/zh/testing-types/performance-testing/scripts/batch_convert_templates.py)。
