...
源目录现有 17 个脚本入口。可以先看 [scripts/batch_convert_templates.py](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/zh/testing-workflows/release-testing-workflow/scripts/batch_convert_templates.py)。
...
- [发布测试工作流程 辅助脚本：batch_convert_templates.py](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/zh/testing-workflows/release-testing-workflow/scripts/batch_convert_templates.py)
- [Awesome QA Skills：发布测试工作流程 Skill 源文件](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/zh/testing-workflows/release-testing-workflow)
- [发布测试工作流程 Skill 详情页](https://inaodeng.com/zh-cn/qaskills/release-testing-workflow/)
