...
- [打开 发布测试工作流程 源目录](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/zh/testing-workflows/release-testing-workflow)
...
- [scripts/batch_convert_templates.py](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/zh/testing-workflows/release-testing-workflow/scripts/batch_convert_templates.py)
- [打开 发布测试工作流程 源目录](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/zh/testing-workflows/release-testing-workflow)
