---
title: "性能负载建模：从“把生产交易量、峰值活动和用户行为转成可复现的结账性能负载模型”到可复核结论"
...
把生产交易量、峰值活动和用户行为转成可复现的结账性能负载模型。这类任务很容易被写成一张泛泛的检查表，最后没人知道应该先做什么，也没法复核结论。性能负载建模 的入口约束把重点拉回证据、范围和下一步动作。

## 先回到源 Skill

这个 Skill 的完整执行规则在 [prompts/performance-workload-modeling.md](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/zh/testing-types/performance-workload-modeling/prompts/performance-workload-modeling.md)。源目录还包含 3 个评测用例，用于验证输出是否遵守契约。
...
- [打开 性能负载建模 源目录](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/zh/testing-types/performance-workload-modeling)
...
- [prompts/performance-workload-modeling.md](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/zh/testing-types/performance-workload-modeling/prompts/performance-workload-modeling.md)
- [打开 性能负载建模 源目录](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/zh/testing-types/performance-workload-modeling)
