...
- [打开 Selenium UI 自动化测试 源目录](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/zh/testing-types/ui-test-selenium)
...
- [references/framework-spec.md](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/zh/testing-types/ui-test-selenium/references/framework-spec.md)
- [scripts/run-tests.sh](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/zh/testing-types/ui-test-selenium/scripts/run-tests.sh)
- [打开 Selenium UI 自动化测试 源目录](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/zh/testing-types/ui-test-selenium)
