---
title: "提示词测试 Skill：Prompt 改了一句，多轮行为会不会漂"
...
- [LLM 测试](https://inaodeng.com/zh-cn/qaskills/llm-testing/)：比较事实、拒答、稳定性和安全边界。
- [LLM 评测设计](https://inaodeng.com/zh-cn/qaskills/llm-evaluation-design/)：固定样本、评分规则和回归门槛。
- [提示注入测试](https://inaodeng.com/zh-cn/qaskills/prompt-injection-testing/)：覆盖恶意指令、越权和数据外泄。
