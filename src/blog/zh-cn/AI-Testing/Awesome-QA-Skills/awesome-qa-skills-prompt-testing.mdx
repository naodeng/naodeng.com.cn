---
title: "提示词测试：从“验证订单助手 Prompt 在指令遵循、事实引用、边界拒答、多轮一致性与版本回归上的表现”到可复核结论"
...
验证订单助手 Prompt 在指令遵循、事实引用、边界拒答、多轮一致性与版本回归上的表现。这类任务很容易被写成一张泛泛的检查表，最后没人知道应该先做什么，也没法复核结论。提示词测试 的入口约束把重点拉回证据、范围和下一步动作。

## 先回到源 Skill

这个 Skill 的完整执行规则在 [prompts/prompt-testing.md](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/zh/testing-types/prompt-testing/prompts/prompt-testing.md)。源目录还包含 3 个评测用例，用于验证输出是否遵守契约。
...
- [打开 提示词测试 源目录](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/zh/testing-types/prompt-testing)
...
- [prompts/prompt-testing.md](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/zh/testing-types/prompt-testing/prompts/prompt-testing.md)
- [打开 提示词测试 源目录](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/zh/testing-types/prompt-testing)
