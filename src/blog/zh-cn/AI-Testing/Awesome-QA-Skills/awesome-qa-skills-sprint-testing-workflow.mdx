...
源目录现有 17 个脚本入口。可以先看 [scripts/batch_convert_templates.py](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/zh/testing-workflows/sprint-testing-workflow/scripts/batch_convert_templates.py)。
...
- [迭代测试工作流程 辅助脚本：batch_convert_templates.py](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/zh/testing-workflows/sprint-testing-workflow/scripts/batch_convert_templates.py)
- [Awesome QA Skills：迭代测试工作流程 Skill 源文件](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/zh/testing-workflows/sprint-testing-workflow)
- [迭代测试工作流程 Skill 详情页](https://inaodeng.com/zh-cn/qaskills/sprint-testing-workflow/)
