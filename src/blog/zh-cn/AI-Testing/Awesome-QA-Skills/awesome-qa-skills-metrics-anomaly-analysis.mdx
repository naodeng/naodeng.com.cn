---
title: "指标异常分析：从“识别结账成功率与延迟异常，验证异常窗口、指标口径、影响范围和候选原因”到可复核结论"
...
识别结账成功率与延迟异常，验证异常窗口、指标口径、影响范围和候选原因。这类任务很容易被写成一张泛泛的检查表，最后没人知道应该先做什么，也没法复核结论。指标异常分析 的入口约束把重点拉回证据、范围和下一步动作。

## 先回到源 Skill

这个 Skill 的完整执行规则在 [prompts/metrics-anomaly-analysis.md](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/zh/testing-types/metrics-anomaly-analysis/prompts/metrics-anomaly-analysis.md)。源目录还包含 3 个评测用例，用于验证输出是否遵守契约。
...
- [打开 指标异常分析 源目录](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/zh/testing-types/metrics-anomaly-analysis)
...
- [prompts/metrics-anomaly-analysis.md](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/zh/testing-types/metrics-anomaly-analysis/prompts/metrics-anomaly-analysis.md)
- [打开 指标异常分析 源目录](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/zh/testing-types/metrics-anomaly-analysis)
