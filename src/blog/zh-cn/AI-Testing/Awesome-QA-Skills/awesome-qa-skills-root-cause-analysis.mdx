---
title: "根因分析：从“针对支付失败事故构建可验证的根因假设，区分触发因素、扩散路径和修复验证”到可复核结论"
...
针对支付失败事故构建可验证的根因假设，区分触发因素、扩散路径和修复验证。这类任务很容易被写成一张泛泛的检查表，最后没人知道应该先做什么，也没法复核结论。根因分析 的入口约束把重点拉回证据、范围和下一步动作。

## 先回到源 Skill

这个 Skill 的完整执行规则在 [prompts/root-cause-analysis.md](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/zh/testing-types/root-cause-analysis/prompts/root-cause-analysis.md)。源目录还包含 3 个评测用例，用于验证输出是否遵守契约。
...
- [打开 根因分析 源目录](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/zh/testing-types/root-cause-analysis)
...
- [prompts/root-cause-analysis.md](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/zh/testing-types/root-cause-analysis/prompts/root-cause-analysis.md)
- [打开 根因分析 源目录](https://github.com/naodeng/awesome-qa-skills/tree/main/skills/zh/testing-types/root-cause-analysis)
