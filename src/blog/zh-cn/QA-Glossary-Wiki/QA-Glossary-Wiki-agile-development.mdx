...
description: "这篇博文是软件测试术语分享系列的一部分，集中讨论 Agile Development（敏捷开发）。文章深入解析了敏捷开发的基础概念和其在软件开发中的重要性，探讨了敏捷方法论的原则，各个角色与职责的分工，以及敏捷实践中软件测试的关键作用。读者将了解如何在敏捷团队中协同工作，提高交付效率，并应对变化。通过这个系列分享，读者将对敏捷开发的理念、方法和软件测试在敏捷环境中的实践有更深刻的了解。"
date: 2024-02-27T04:06:44.000Z
author: "nao.deng"
tags: ["自动化测试","CI/CD","敏捷测试","最佳实践","测试策略","QA 术语"]
categories: ["软件开发模型"]
series: ["软件测试术语分享"]
cover: "./QA-Glossary-Wiki-agile-development-cover.png"
