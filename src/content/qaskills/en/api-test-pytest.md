...
## Usage Guide
1. Install and enable `api-test-pytest` first (use the install commands in this page).
2. In your request, provide required context: scope, environment, timeline, and expected output format.
3. Trigger with API context, for example: "Use `api-test-pytest` on /orders and /payments in staging."
...
### What
- Validate request/response behavior using pytest-based API automation and assertion layering.
