...
[文档测试](/zh-cn/wiki/documentation-testing/) 通过确保**用户指南**、**[API](/zh-cn/wiki/api/) 文档**和**帮助文件**准确反映软件的功能来增强[软件质量](/zh-cn/wiki/software-quality/)。文档和软件行为之间的这种一致性对于依赖文档来有效理解和使用产品的**最终用户**、**开发人员**和**利益相关者**至关重要。
  ...
  此外，[文档测试](/zh-cn/wiki/documentation-testing/) 可以发现软件本身的不一致或差距，从而改进代码或用户界面。它充当[verification](/zh-cn/wiki/verification/) 的附加层，可以揭示**可用性问题**或对预期功能的**误解**。
...
测试人员在[文档测试](/zh-cn/wiki/documentation-testing/) 中的角色是多方面的，重点是**[verification](/zh-cn/wiki/verification/)** 和文档的**改进**。他们必须确保所有书面材料（例如帮助文件、用户指南和在线资源）**清晰**、**简洁**和**准确**。测试人员负责：
