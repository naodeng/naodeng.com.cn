...
为了减轻这些风险，**微调 [安全测试](/zh-cn/wiki/security-testing/) 工具**和**流程**以最大限度地减少 [误报](/zh-cn/wiki/false-positive/) 至关重要。这包括使用正确的应用程序上下文配置安全扫描器，维护最新的威胁[数据库](/zh-cn/wiki/database/)，以及使用**补充手册[验证 ](/zh-cn/wiki/verification/)**来确认潜在的安全问题。
