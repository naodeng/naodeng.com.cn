...
### 相关术语：
- 测试脚本 (Test Scripts)
[测试脚本 (Test Scripts)](/zh-cn/wiki/test-script/)
- 自动化测试 (Automated Testing)
[自动化测试 (Automated Testing)](/zh-cn/wiki/automated-testing/)
- API (Application Programming Interface)
[API (Application Programming Interface)](/zh-cn/wiki/api/)
- Selenium
[Selenium](/zh-cn/wiki/selenium/)
- WebDriver
[WebDriver](/zh-cn/wiki/webdriver/)

## 关于 Web 自动化 (Web Automation) 的问题？
