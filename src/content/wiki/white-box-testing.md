...
### 相关术语：
- [黑盒测试 (Black Box Testing)](/zh-cn/wiki/black-box-testing/)
- [灰盒测试 (Grey Box Testing)](/zh-cn/wiki/grey-box-testing/)
- [玻璃盒测试 (Glass Box Testing)](/zh-cn/wiki/glass-box-testing/)

## 关于白盒测试 (White Box Testing) 的问题？
