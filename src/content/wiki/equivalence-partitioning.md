---
title: "关于等价类划分的问题？ ｜ Equivalence Partitioning"
description: "# 关于等价类划分的问题？ ｜ Equivalence Partitioning #### 基础与重要性 - 软件测试中的等价类划分是什么？ 等价类划分 (Equivalence Partitioning) 是一种黑盒测试方法，它将软件单元的输入数据划分为若干等价的数据分区。"
section: "E"
order: 0
---

# 关于等价类划分的问题？ ｜ Equivalence Partitioning
#### 基础与重要性
- **软件测试中的等价类划分是什么？**
