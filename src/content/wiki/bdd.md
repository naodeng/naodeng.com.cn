...
- [行为驱动开发 ｜ BDD](#行为驱动开发--bdd)
  ...
  - [关于 BDD 有疑问吗？](#关于-bdd-有疑问吗)
    - [BDD 的基础知识和重要性](#bdd-的基础知识和重要性)
      - [什么是行为驱动开发（BDD）？](#什么是行为驱动开发bdd)
      - [BDD 在软件开发中为什么重要？](#bdd-在软件开发中为什么重要)
    - [BDD 的关键原则](#bdd-的关键原则)
    - [BDD 与传统测试方法的区别](#bdd-与传统测试方法的区别)
    - [使用 BDD 的好处](#使用-bdd-的好处)
    - [BDD 的实施和工具](#bdd-的实施和工具)
      - [在 BDD 中常用的工具有哪些？](#在-bdd-中常用的工具有哪些)
      - [在软件开发项目中如何实施 BDD？](#在软件开发项目中如何实施-bdd)
    - [BDD 中的“给定 - 当 - 那么”格式的作用是什么？](#bdd-中的给定---当---那么格式的作用是什么)
    - [如何编写一个好的 BDD 场景？](#如何编写一个好的-bdd-场景)
    - [一些 BDD 框架的例子](#一些-bdd-框架的例子)
    - [BDD 与敏捷](#bdd-与敏捷)
      - [BDD 如何适应敏捷开发？](#bdd-如何适应敏捷开发)
      - [BDD 与敏捷中的用户故事有什么关系？](#bdd-与敏捷中的用户故事有什么关系)
      - [BDD 如何改善敏捷团队中的沟通？](#bdd-如何改善敏捷团队中的沟通)
      - [BDD 如何帮助管理敏捷项目中的变化？](#bdd-如何帮助管理敏捷项目中的变化)
    - [挑战和最佳实践](#挑战和最佳实践)
      - [实施 BDD 时会遇到哪些挑战？](#实施-bdd-时会遇到哪些挑战)
      - [BDD 的最佳实践是什么？](#bdd-的最佳实践是什么)
      - [如何克服这些挑战？](#如何克服这些挑战)
...
- [Behavior Driven Development](https://inaodeng.com/zh-cn/wiki/bdd/)
- [gherkin](https://inaodeng.com/zh-cn/wiki/gherkin/)
