---
title: "测试管理 ｜ Test Management"
description: "测试管理 (Test Management) 是监督和协调测试阶段涉及的各种活动的过程。它涵盖了确保测试系统化、可重复且有效所需的组织、控制和文档化工作。这包括定义测试目标、选择合适的测试方法、管理 测试用例 (test cases) 和场景等测试资产，并确保所有测试活动与项目目标和时间线保持一致…"
section: "T"
related:
...
- [测试管理 ｜ Test Management](#测试管理--test-management)
  ...
  - [有关测试管理的问题吗？](#有关测试管理的问题吗)
    ...
    - [与其他流程集成](#与其他流程集成)
      ...
      - [测试管理在持续集成和持续交付（CI/CD）中的作用是什么？](#测试管理在持续集成和持续交付cicd中的作用是什么)
      - [测试管理如何支持敏捷和 DevOps 方法？](#测试管理如何支持敏捷和-devops-方法)
<!-- TOC END -->
测试管理监督测试过程、文档和其他软件方面，确保彻底的测试和高质量的软件交付。
...
- **测试倡导**：在更广泛的开发团队中倡导测试的重要性，并倡导有足够的时间和资源来进行彻底的测试。 从本质上讲，测试经理确保测试团队顺利运作，与项目目标保持一致，并为高质量软件产品的交付做出贡献。
