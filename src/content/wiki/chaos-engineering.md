...
- **建立信心**：了解系统可以处理混乱事件可以增加对其稳定性和性能的信心。
  [混沌工程](/zh-cn/wiki/chaos-engineering/) 通过确保系统针对真实场景进行实战测试，超越了传统测试的限制，从而形成更具弹性的基础设施。
...
- **建立韧性文化**：鼓励一种心态，将失败视为学习和改进系统的机会。
  通过遵循这些策略，您可以降低与 [混沌工程](/zh-cn/wiki/chaos-engineering/) 相关的风险，同时仍然获得其好处。
...
- **第一资本**：第一资本将 [混沌工程](/zh-cn/wiki/chaos-engineering/) 应用于其银行服务，以确保其系统能够承受各种中断和中断。这种积极主动的方法帮助他们在影响客户之前识别并纠正弱点，从而打造更强大的银行平台。
  这些示例演示了 [混沌工程](/zh-cn/wiki/chaos-engineering/) 如何提供主动方法来发现和解决系统漏洞，从而为各个行业提供更具弹性和可靠的服务。
