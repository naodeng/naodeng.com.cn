...
description: "再次测试是验证早期测试中发现的缺陷是否已成功修复的过程。它涉及在开发团队解决缺陷后，重新运行最初因缺陷而失败的相同测试用例 (Test Cases)。再次测试的首要重点是确保特定问题已解决，且更正后的功能现在表现符合预期…"
section: "R"
related:
  - automated-testing
  - manual-testing
...
- **资源优化**：它使人类测试人员能够专注于需要人类判断的更复杂的测试任务。 然而，也存在**挑战**：
