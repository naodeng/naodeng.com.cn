...
- [再次测试的重要性](#再次测试的重要性)
- [再次测试策略与技术](#再次测试策略与技术)
- [再次测试工具与自动化](#再次测试工具与自动化)
- [Agile 和 DevOps 中的再次测试](#agile-和-devops-中的再次测试)
...
- **再次测试与回归测试有何不同？**
  再次测试和回归测试是软件[测试自动化](/zh-cn/wiki/test-automation/)中不同的过程。
...
### 再次测试工具与自动化
- **常用的再次测试工具有哪些？**
  [Selenium](/zh-cn/wiki/selenium/)、TestComplete、QTP/UFT、Ranorex、Appium、JUnit/TestNG、[Cypress](/zh-cn/wiki/cypress/)、Robot Framework。
