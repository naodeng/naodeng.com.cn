...
6. **[静态测试](https://inaodeng.com/zh-cn/wiki/static-testing/)**：[V 型](https://inaodeng.com/zh-cn/wiki/v-model/) 推广[静态测试](https://inaodeng.com/zh-cn/wiki/static-testing/) 方法，例如评论和[检查s](https://inaodeng.com/zh-cn/wiki/inspection/)，以在不执行代码的情况下捕获缺陷。
