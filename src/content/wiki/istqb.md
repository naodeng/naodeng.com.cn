...
- **及格分数**：65%（满分 40 分中的 26 分）。 对于**高级**考试，其格式类似，但包含更多基于场景的问题：

- **多项选择**：问题可能有一个或多个正确答案。
- **问题数量**：因模块而异（例如，测试经理、测试分析师）。
- **持续时间**：每个模块 180 分钟。
- **及格分数**：65%。 **专家级**考试更加复杂，除了多项选择之外，可能还包括论文类型的问题。
...
- **及格分数**：65%（满分 40 分中的 26 分）。 考试通常在网上或在考试中心进行，有些地区提供纸笔考试。
...
- **实际应用**：它强调将知识应用到 **现实生活场景** ，包括定义测试目标和策略。

- **专业化**：考生可以从三个模块中进行选择—— **测试经理、测试分析师** , 和 **技术测试分析师** ——与他们的职业重点保持一致。

- **领导技能**：它涵盖以下方面 **领导测试团队** 、管理资源，以及 **评估工具**用于测试自动化。

- **分析技能**：更加强调 **分析**域、被测系统和测试流程。 要参加高级考试，考生必须拥有基础级证书，并且通常需要**18 个月**的实践经验。考试本身更加严格，有**基于场景的问题**，测试考生在复杂情况下应用概念的能力。
...
- 认识到的重要性 **测试独立性**以及如何实现它，这可以带来更客观的测试结果。
