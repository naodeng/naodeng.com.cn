...
description: "手动测试 (Manual Testing) 是指在不使用自动化工具的情况下，由人工执行测试用例 (test cases) 的过程。测试人员通过遵循一组预定义的测试用例，确保软件行为符合预期。它涉及测试人员与应用程序界面交互、提供输入并观察输出，以验证应用程序行为的正确性。由于手动测试依赖于人类的观察…"
section: "M"
related:
  - automated-testing
  - test-case
...
- [手动测试 ｜ Manual Testing](#手动测试--manual-testing)
  ...
  - [有关手动测试的问题吗？](#有关手动测试的问题吗)
    ...
    - [手动测试过程](#手动测试过程)
      ...
      - [什么是测试用例设计以及一个好的测试用例的关键要素是什么？](#什么是测试用例设计以及一个好的测试用例的关键要素是什么)
...
- **正式结束**：获得利益相关者的正式签字，表明接受测试工作并且产品已准备好发布。 这些活动确保了测试工作的结构化和可追溯性，为未来的项目提供了宝贵的见解，并保持了测试过程的完整性。
...
- **指标和报告**：该工具生成有助于评估软件质量和测试过程效率的报告和指标。 通过使用缺陷跟踪工具，团队可以确保没有缺陷被漏掉，并且可以提高软件产品的整体质量。它还通过提供缺陷解决工作流程的清晰可视性，促进更好的资源分配和项目管理。
...
- **利用思维导图**可视化测试覆盖范围并识别测试中的差距。

- **不断学习**关于被测应用程序；更深入的理解会带来更有洞察力的测试场景。

- **与开发人员合作**深入了解可能影响测试的代码更改。

- **收集反馈**来自利益相关者的帮助，使测试工作与业务要求和用户需求保持一致。
...
- **投资测试人员培训**保持技能敏锐和知识最新，特别是在新的测试技术或领域专业知识等领域。
