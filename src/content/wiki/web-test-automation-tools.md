...
description: "Web 测试自动化工具 是一种自动化 Web 应用程序测试过程的软件应用程序。它模拟用户与 Web 浏览器的交互，检查错误、兼容性和性能问题。这些工具通常提供录制操作、创建 测试脚本 并通过代码脚本或 GUI 界面重放它们的方法。 例如，Selenium WebDriver 允许您使用 Java、C# 和 Python 等各种编程语言编写测试："
section: "W"
order: 0
---
...
[质量保证 (Quality Assurance)](/zh-cn/wiki/quality-assurance/)[敏捷开发 (Agile Development)](/zh-cn/wiki/agile-development/)
