...
<!-- TOC END -->
＃ 胖的工厂验收测试 （胖的）确认新制造的设备按预期运行并满足客户的要求。
...
[FAT](https://inaodeng.com/zh-cn/wiki/fat/) 代表**工厂[验收测试](https://inaodeng.com/zh-cn/wiki/acceptance-testing/)**。这是一种预交付[检查](https://inaodeng.com/zh-cn/wiki/inspection/)，其中软件在受控环境（通常是在开发人员的站点）中进行测试，以确保其在运送到客户所在地之前满足商定的规范和要求。此阶段对于根据定义的标准验证软件的功能和性能至关重要，并且通常是合同义务。
...
- **记录测试结果**一丝不苟地捕获每个测试用例的预期结果和实际结果。

- **识别、记录和报告缺陷**向开发团队提供足够的详细信息，以促进快速有效的解决方案。

- **验证修复**对于 FAT 期间发现的任何问题，确保在重新测试之前每个问题都得到圆满解决。

- **与利益相关者合作** ，其中可能包括项目经理、开发人员和客户代表，以审查测试结果并获得必要的批准。
...
- **组织** FAT 的后勤工作，例如测试团队、设备和设施的可用性。

- **监控** FAT 相对于项目时间表的进度，并根据需要进行调整以保持正轨。

- **促进**测试工程师、开发人员和客户之间的协作，以确保全面的测试方法。

- **确保**测试环境是根据成功 FAT 所需的规范准备的。

- **管理**分配给 FAT 的预算以避免不必要的开支。

- **寻址**及时处理 FAT 流程中出现的任何问题或冲突。

- **正在审查**和 **批准**测试用例和计划，以确认它们符合项目的质量标准。
