---
title: "Bruno API Testing: Project Setup"
...
![Bruno collection setup in the Testcase project](https://cdn.jsdelivr.net/gh/naodeng/blogimg@master/uPic/bkIvUi.png)
...
![Bruno GET request configuration for GetDemo](https://cdn.jsdelivr.net/gh/naodeng/blogimg@master/uPic/XYeiXB.png)
...
![Bruno built-in assertions for a GET request](https://cdn.jsdelivr.net/gh/naodeng/blogimg@master/uPic/z86CB2.png)
...
![Bruno GET request assertion results](https://cdn.jsdelivr.net/gh/naodeng/blogimg@master/uPic/YkAbiG.png)
...
![Bruno JavaScript test assertions for a GET request](https://cdn.jsdelivr.net/gh/naodeng/blogimg@master/uPic/ubyRwj.png)

- Debugging Assertions: Click the Run button in the upper right corner to execute the assertions and check if the results meet expectations.
![Bruno GET assertion results after running the test](https://cdn.jsdelivr.net/gh/naodeng/blogimg@master/uPic/3pAMDd.png)
...
![Bruno POST request configuration for PostDemo](https://cdn.jsdelivr.net/gh/naodeng/blogimg@master/uPic/3IP5B4.png)
...
![Bruno JSON request body for a POST request](https://cdn.jsdelivr.net/gh/naodeng/blogimg@master/uPic/psbGLD.png)
...
![Bruno built-in assertions for a POST request](https://cdn.jsdelivr.net/gh/naodeng/blogimg@master/uPic/oN8D5G.png)

- Debugging Assertions: Click the Run button in the upper right corner to execute the assertions and check if the results meet expectations.
![Bruno POST assertion results after running the test](https://cdn.jsdelivr.net/gh/naodeng/blogimg@master/uPic/HKb4fn.png)
...
- Debugging Assertions: Click the Run button in the upper right corner to execute the assertions and check if the results meet expectations.
![Bruno JavaScript test assertions for a POST request](https://cdn.jsdelivr.net/gh/naodeng/blogimg@master/uPic/mkKIsE.png)
...
![Bruno API test collection run results](https://cdn.jsdelivr.net/gh/naodeng/blogimg@master/uPic/CvfPIn.png)
...
![Bruno environment variable configuration](https://cdn.jsdelivr.net/gh/naodeng/blogimg@master/uPic/YDKvOr.png)
...
![Bruno environment variable test run results](https://cdn.jsdelivr.net/gh/naodeng/blogimg@master/uPic/NfAX6z.png)
...
![Bruno CLI API test execution](https://cdn.jsdelivr.net/gh/naodeng/blogimg@master/uPic/iKnEYL.png)
...
![Bruno JSON test report output](https://cdn.jsdelivr.net/gh/naodeng/blogimg@master/uPic/MM85y5.png)

- Confirm that the test report file is generated successfully.
![Bruno generated JSON test report](https://cdn.jsdelivr.net/gh/naodeng/blogimg@master/uPic/jnJHMQ.png)
