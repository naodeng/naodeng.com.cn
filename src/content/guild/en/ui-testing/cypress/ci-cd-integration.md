---
title: "Cypress in CI: Headless Runs, Browser Choice, and Artifacts"
description: "Run Cypress in CI with a reproducible application server and publish failure evidence."
testType: ui-testing
framework: cypress
