---
title: "Playwright Locators, Assertions, and Auto-waiting"
description: "Write resilient Playwright tests with user-facing locators and web-first assertions."
testType: ui-testing
...
Turn the scenario into a named file, place data in a dedicated fixture or CSV, and pass the target from an environment variable. This is the point to add the locators-and-auto-waiting concern: use the tool’s native waiting, transaction, interception, report, or configuration mechanism rather than a generic sleep or hidden global default. The following command/configuration keeps the focus on a semantic locator with a web-first assertion; it is also a useful smoke command for a pull request.
...
// Run the focused locators-and-auto-waiting scenario.
// npx playwright test tests/locators_and_auto_waiting.spec.ts --project=chromium
```
