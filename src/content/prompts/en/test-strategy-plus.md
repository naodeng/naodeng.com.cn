...
| Gates | May mention entry/exit thinking | **Checkable quality gates** (metrics or clear criteria---not --útested enough--ù) |
...
- Priority: business impact √ó change risk √ó cost of visible failure.
...
- --úFully tested--ù / --úcomprehensive coverage--ù are invalid gate criteria.
...
- Gates that only say --útesting complete--ù with no checkable criteria.
