---
title: "Test Strategy Prompt"
description: "Supports Test Strategy Prompt by organizing input evidence, constraints, risks, validation priorities, decision criteria, and actionable QA next steps without inventing facts."
testingType: "test-strategy"
category: "Requirements, Planning, And Test Strategy"
categoryOrder: 1
sourcePath: "testing-types/en/test-strategy/Standard-version/TestStrategyPrompt.md"
lang: "en"
order: 225
---
...
```text
Test Manager
--œ------ Functional Test Team
--‚   --œ------ Senior Test Engineers Ã— 2
--‚   --œ------ Test Engineers Ã— 4
--‚   --------- Junior Test Engineers Ã— 2
--œ------ Automation Test Team
--‚   --œ------ Automation Test Architect Ã— 1
--‚   --œ------ Automation Test Engineers Ã— 3
--‚   --------- Automation Test Developers Ã— 2
--------- Specialized Test Team
    --œ------ Performance Test Engineers Ã— 2
    --œ------ Security Test Engineer Ã— 1
    --------- Mobile Test Engineers Ã— 2
```
...
- **Return on Investment:** [Benefits/Investment Ã— 100%]
