...
5. Loose verbal goals (--úsurvive Black Friday--ù, --úAPIs must not be slow--ù)
...
- End with an Open Questions list (see Output ¬ß6) covering at least: peak traffic, target p95/error rate, safe-to-load env, data and auth
...
- Suggested order (1-VU smoke -Üí chosen scenario -Üí optional push)
...
- [ ] P0 transactions and load model are concrete and actionable --- not --úcare about performance--ù fluff
