---
title: "功能测试 Prompt"
description: "用于功能测试 Prompt 的风险识别、证据梳理与可执行测试建议输出。"
testingType: "functional-testing"
category: "测试分析与测试设计"
categoryOrder: 2
sourcePath: "testing-types/zh/functional-testing/Standard-version/FunctionalTestingPrompt.md"
lang: "zh-cn"
order: 91
---
# 功能测试 Prompt

<!-- Prompt purpose: 用于功能测试 Prompt 的风险识别、证据梳理与可执行测试建议输出。 -->
## 平台场景说明
