---
title: "需求分析 Prompt"
description: "用于需求分析 Prompt 的风险识别、证据梳理与可执行测试建议输出。"
testingType: "requirements-analysis"
category: "需求、规划与测试策略"
categoryOrder: 1
sourcePath: "testing-types/zh/requirements-analysis/Standard-version/RequirementsAnalysisPrompt.md"
lang: "zh-cn"
order: 172
---
# 需求分析 Prompt

<!-- Prompt purpose: 用于需求分析 Prompt 的风险识别、证据梳理与可执行测试建议输出。 -->
## 平台场景说明
