...
function getHeadings() {
  return [{
    "depth": 2,
    "slug": "第-17-天利用人工智能实现缺陷报告自动化并分享你的流程和评估结果",
    "text": "第 17 天：利用人工智能实现缺陷报告自动化，并分享你的流程和评估结果"
  }, {
    "depth": 3,
    "slug": "任务步骤",
    "text": "任务步骤"
...
function _createMdxContent(props) {
  ...
  return createVNode(Fragment, {
    children: [createVNode(_components.h2, {
      id: "第-17-天利用人工智能实现缺陷报告自动化并分享你的流程和评估结果",
      children: "第 17 天：利用人工智能实现缺陷报告自动化，并分享你的流程和评估结果"
    }), "\n", createVNode(_components.p, {
      children: "今天是第 17 天！今天，我们将探索使用人工智能自动化缺陷检测和报告流程的潜力。"
    }), "\n", createVNode(_components.p, {
      children: "作为测试人员，我们知道高效的缺陷报告对于与团队的有效沟通和协作非常重要。然而，这个过程可能非常耗时且容易出错，特别是在处理复杂的应用程序或大型测试套件时。人工智能驱动的缺陷报告工具有望通过自动检测和报告缺陷来简化这一过程，从而可能节省时间并提高准确性。"
    }), "\n", createVNode(_components.p, {
      children: "然而，与任何人工智能技术一样，严格评估使用人工智能进行缺陷报告的有效性和潜在风险非常重要。在今天的任务中，我们将尝试使用人工智能工具来检测和报告缺陷并评估其质量。"
      ...
      children: ["\n", createVNode(_components.li, {
        children: ["\n", createVNode(_components.p, {
          children: [createVNode(_components.strong, {
            children: "尝试 AI 进行缺陷报告"
          }), ": 选择一个 AI 缺陷检测和报告工具或平台。在这个挑战的早期，我们列出了工具及其特性的清单，因此请回顾那些帖子或进行自己的研究。许多免费或试用版本都可以在线获得。探索工具的功能，并在一个样本应用程序或项目上进行实验。"]
        }), "\n"]
      }), "\n", createVNode(_components.li, {
        children: ["\n", createVNode(_components.p, {
          children: [createVNode(_components.strong, {
            children: "评估报告质量"
          }), ": 评估 AI 生成的缺陷报告的准确性、完整性和质量。考虑："]
        }), "\n", createVNode(_components.ul, {
          children: ["\n", createVNode(_components.li, {
            children: "AI 识别的缺陷是否有效？"
          }), "\n", createVNode(_components.li, {
            children: "AI 生成的报告是否详细、清晰且具有可操作性？"
          }), "\n", createVNode(_components.li, {
            children: "信息质量与手动创建的缺陷报告相比如何？"
          }), "\n"]
        }), "\n"]
      }), "\n", createVNode(_components.li, {
        children: ["\n", createVNode(_components.p, {
        ...
        children: ["\n", createVNode(_components.p, {
          children: [createVNode(_components.strong, {
            children: "数据使用和保护"
          }), ": 调查 AI 工具如何利用你的缺陷数据生成报告。考虑以下问题："]
        }), "\n", createVNode(_components.ul, {
          children: ["\n", createVNode(_components.li, {
            children: [createVNode(_components.strong, {
              children: "数据匿名化"
            }), ": 你的数据在被 AI 使用之前是否被匿名化？"]
          }), "\n", createVNode(_components.li, {
            children: [createVNode(_components.strong, {
              children: "数据安全"
            }), ": 你的数据在工具内部如何安全？"]
        ...
        children: ["\n", createVNode(_components.p, {
          ...
          children: ["\n", createVNode(_components.li, {
            children: ["\n", createVNode(_components.p, {
              children: "你使用的 AI 工具及其功能的体验"
            }), "\n"]
          }), "\n", createVNode(_components.li, {
            children: ["\n", createVNode(_components.p, {
              children: "你对缺陷报告质量的评估"
            }), "\n"]
          }), "\n", createVNode(_components.li, {
            children: ["\n", createVNode(_components.p, {
              children: "你识别的风险和限制"
            ...
            children: ["\n", createVNode(_components.p, {
              children: "你对数据使用和潜在数据保护问题的看法"
            }), "\n"]
          }), "\n", createVNode(_components.li, {
            children: ["\n", createVNode(_components.p, {
              children: "你对 AI 在自动化缺陷检测和报告方面的整体评估，考虑："
            }), "\n", createVNode(_components.ul, {
              children: ["\n", createVNode(_components.li, {
                children: "它与你传统的缺陷报告方法相比如何？"
              }), "\n", createVNode(_components.li, {
                children: "它是否识别了你可能会忽略的任何缺陷？"
              }), "\n", createVNode(_components.li, {
                children: "它如何影响缺陷报告过程的整体效率？"
              }), "\n"]
            }), "\n"]
          }), "\n"]
        }), "\n"]
      ...
      children: ["\n", createVNode(_components.li, {
        children: [createVNode(_components.strong, {
          children: "探索效率提升"
        }), ": 了解 AI 如何改进缺陷报告流程，潜在地节省时间并提高报告质量。"]
      }), "\n", createVNode(_components.li, {
        children: [createVNode(_components.strong, {
          children: "了解 AI 的限制"
        }), ": 通过对用于缺陷报告的 AI 工具进行批判性评估，你将深入了解其当前的能力和限制，有助于设定现实的预期。"]
      }), "\n", createVNode(_components.li, {
        children: [createVNode(_components.strong, {
          children: "增强测试实践"
        }), ": 分享你的发现有助于我们共同理解 AI 在自动化缺陷检测和报告中的作用和潜力。"]
      }), "\n"]
    }), "\n", createVNode(_components.h3, {
      id: "任务链接",
      children: "任务链接"
      ...
      children: "今天的任务让我有一些挣扎，目前我还没有完全使用过 AI 测试工具进行缺陷报告，目前大部分的 AI 工具都需要注册且登录后进行申请试用，大部分的数据都会被这些工具平台去收集，我试用这些工具时都比较谨慎，担心数据隐私泄露，由于使用的限制和数据安全的考虑，试用的时间不够充分，估无法评估工具的质量和进行详细的分享。"
    }), "\n", createVNode(_components.p, {
      children: ["1.", createVNode(_components.strong, {
        children: "评估 AI 报告质量"
      })]
    }), "\n", createVNode(_components.p, {
      children: "之前试用 Applitools eyes 工具，它会以清晰截图对比的方式进行缺陷报告，不用我们再花时间去复现和构造场景"
    }), "\n", createVNode(_components.p, {
      children: ["2.", createVNode(_components.strong, {
        children: "识别风险和限制"
      })]
    }), "\n", createVNode(_components.p, {
      children: "由于试用时间有限，目前未发现有什么漏报和误报的风险"
    }), "\n", createVNode(_components.p, {
      children: ["3.", createVNode(_components.strong, {
        children: "数据使用和保护"
      })]
    }), "\n", createVNode(_components.p, {
      children: "目前看起来 Applitools eyes 工具的安全风险和数据保护做的一般，本地配置 api key 运行测试后，Applitools eyes 平台就能获取测试过程截图和结果，我个人担心存在数据隐私泄露的问题。"
    }), "\n", createVNode(_components.p, {
      children: ["4.", createVNode(_components.strong, {
        children: "分享你的发现"
      })]
    }), "\n", createVNode(_components.p, {
      children: "基于之前使用其他 AI 测试工具和 这一次使用 Applitools eyes 工具，与人工缺陷报告的差异点："
    }), "\n", createVNode(_components.ul, {
      children: ["\n", createVNode(_components.li, {
        children: "AI 工具识别到缺陷后就直接反馈缺陷了，而不像人工发现缺陷后会多次复现和识别，确认缺陷的有效性和真实性。"
      }), "\n", createVNode(_components.li, {
        children: "AI 工具缺陷上报会有清晰的复现步骤，而人工缺陷报告时常出现忘记复现步骤导致偶发缺陷遗漏的情况。"
      }), "\n", createVNode(_components.li, {
        children: "AI 工具上报的缺陷会相对死板，可能会让修复的开发人员感到困惑。"
      }), "\n"]
    }), "\n", createVNode(_components.h2, {
      id: "关于活动",
      children: "关于活动"
...
const url = "src/blog/zh-cn/Event/30-days-of-ai-in-testing-day-17-automate-bug-reporting-with-ai-and-share-your-process-and-evaluation.mdx";
const file = "/Users/nao.deng/Desktop/AwsomeCode/naodeng.com.cn/src/blog/zh-cn/Event/30-days-of-ai-in-testing-day-17-automate-bug-reporting-with-ai-and-share-your-process-and-evaluation.mdx";
...
Content.moduleId = "/Users/nao.deng/Desktop/AwsomeCode/naodeng.com.cn/src/blog/zh-cn/Event/30-days-of-ai-in-testing-day-17-automate-bug-reporting-with-ai-and-share-your-process-and-evaluation.mdx";
