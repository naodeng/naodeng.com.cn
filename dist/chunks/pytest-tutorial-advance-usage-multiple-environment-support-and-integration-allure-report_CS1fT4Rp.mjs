...
function getHeadings() {
  return [{
    ...
    "depth": 4,
    "slug": "配置支持多环境的-fixture",
    "text": "配置支持多环境的 fixture"
  }, {
    "depth": 4,
    "slug": "更新测试用例来支持多环境",
    "text": "更新测试用例来支持多环境"
    ...
    "depth": 4,
    "slug": "安装-allure-pytest-依赖",
    "text": "安装 allure-pytest 依赖"
  }, {
    "depth": 4,
    "slug": "配置-allure-pytest",
    "text": "配置 allure-pytest"
  }, {
    "depth": 4,
    "slug": "调整测试用例来支持-allure-报告",
    "text": "调整测试用例来支持 allure 报告"
  }, {
    "depth": 4,
    "slug": "运行测试用例生成-allure-报告",
    "text": "运行测试用例生成 allure 报告"
  }, {
    "depth": 4,
    "slug": "查看-allure-报告",
    "text": "查看 allure 报告"
    ...
    "depth": 4,
    "slug": "调整-cicd-流程来支持-allure-报告",
    "text": "调整 CI/CD 流程来支持 allure 报告"
  }, {
    "depth": 4,
    "slug": "查看-github-action-allure-报告",
    "text": "查看 github action allure 报告"
  }, {
    "depth": 2,
    "slug": "参考",
    "text": "参考"
...
function _createMdxContent(props) {
  ...
  return createVNode(Fragment, {
    children: [createVNode(_components.h2, {
      ...
      children: "在实际的 API 自动化测试过程中，我们需要在不同的环境中运行测试用例，以确保 API 在各个环境中都能正常运行。"
    }), "\n", createVNode(_components.p, {
      children: "通过使用 Pytest 的 fixture 功能，我们可以轻松地实现多环境支持。"
    }), "\n", createVNode(_components.p, {
      ...
      children: ["\n", createVNode(_components.li, {
        children: "编写生产环境测试配置文件"
      }), "\n"]
    }), "\n", createVNode(_components.blockquote, {
      children: ["\n", createVNode(_components.p, {
        children: "根据实际情况配置生产环境测试配置文件"
      }), "\n"]
    }), "\n", createVNode(_components.pre, {
      class: "astro-code github-dark",
      style: {
      ...
      id: "新建不同环境测试数据文件",
      children: "新建不同环境测试数据文件"
    }), "\n", createVNode(_components.blockquote, {
      children: ["\n", createVNode(_components.p, {
        children: "不同环境请求数据文件和响应数据文件分别存储测试用例的不同环境请求数据和不同环境预期响应数据。"
      }), "\n"]
    }), "\n", createVNode(_components.pre, {
      class: "astro-code github-dark",
      style: {
      ...
      children: ["\n", createVNode(_components.p, {
        children: "开发环境请求数据文件中配置了 getAPI 接口的请求数据和 postAPI 接口的请求数据"
      }), "\n"]
    }), "\n", createVNode(_components.pre, {
      class: "astro-code github-dark",
      style: {
      ...
      children: ["\n", createVNode(_components.p, {
        children: "开发环境响应数据文件中配置了 getAPI 接口的响应数据和 postAPI 接口的响应数据"
      }), "\n"]
    }), "\n", createVNode(_components.pre, {
      class: "astro-code github-dark",
      style: {
      ...
      children: ["\n", createVNode(_components.li, {
        children: "编写生产环境请求数据文件"
      }), "\n"]
    }), "\n", createVNode(_components.blockquote, {
      children: ["\n", createVNode(_components.p, {
        children: "生产环境请求数据文件中配置了 getAPI 接口的请求数据和 postAPI 接口的请求数据"
      }), "\n"]
    }), "\n", createVNode(_components.pre, {
      class: "astro-code github-dark",
      style: {
      ...
      children: ["\n", createVNode(_components.li, {
        children: "编写生产环境响应数据文件"
      }), "\n"]
    }), "\n", createVNode(_components.blockquote, {
      children: ["\n", createVNode(_components.p, {
        children: "生产环境响应数据文件中配置了 getAPI 接口的响应数据和 postAPI 接口的响应数据"
      }), "\n"]
    }), "\n", createVNode(_components.pre, {
      class: "astro-code github-dark",
      style: {
      ...
      id: "配置支持多环境的-fixture",
      children: "配置支持多环境的 fixture"
    }), "\n", createVNode(_components.blockquote, {
      children: ["\n", createVNode(_components.p, {
        children: "fixture 会以 conftest.py 文件存储为例，其他格式如 YAML、CSV 等类似，均可参考"
      }), "\n"]
    }), "\n", createVNode(_components.ul, {
      children: ["\n", createVNode(_components.li, {
        children: "项目根目录新建 conftest.py 文件"
      }), "\n"]
    }), "\n", createVNode(_components.pre, {
      class: "astro-code github-dark",
      style: {
      ...
      children: ["\n", createVNode(_components.p, {
        children: "为做区分，这里新建测试用例文件，文件名为 test_demo_multi_environment.py"
      }), "\n"]
    }), "\n", createVNode(_components.pre, {
      class: "astro-code github-dark",
      style: {
      ...
      id: "集成-allure-报告",
      children: "集成 allure 报告"
    }), "\n", createVNode(_components.p, {
      children: "allure 是一个轻量级的、灵活的、易于扩展的测试报告工具，它提供了丰富的报告类型和功能，可以帮助您更好地可视化测试结果。"
    }), "\n", createVNode(_components.p, {
      children: "allure 报告可以与 Pytest 集成，以生成详细的测试报告。"
    }), "\n", createVNode(_components.p, {
      children: ["可参考 demo：", createVNode(_components.a, {
        href: "https://github.com/Automation-Test-Starter/Pytest-API-Test-Demo",
        children: "https://github.com/Automation-Test-Starter/Pytest-API-Test-Demo"
      ...
      id: "安装-allure-pytest-依赖",
      children: "安装 allure-pytest 依赖"
    }), "\n", createVNode(_components.pre, {
      class: "astro-code github-dark",
      style: {
        backgroundColor: "#24292e",
      ...
      children: ["\n", createVNode(_components.p, {
        children: "避免之前安装的 pytest-html-reporter 与 allure-pytest 冲突，建议先卸载 pytest-html-reporter"
      }), "\n"]
    }), "\n", createVNode(_components.pre, {
      class: "astro-code github-dark",
      style: {
      ...
      id: "配置-allure-pytest",
      children: "配置 allure-pytest"
    }), "\n", createVNode(_components.p, {
      children: "更新 pytest.ini 文件来指定 allure 报告的存储位置"
    }), "\n", createVNode(_components.pre, {
      class: "astro-code github-dark",
      style: {
        backgroundColor: "#24292e",
      ...
      id: "调整测试用例来支持-allure-报告",
      children: "调整测试用例来支持 allure 报告"
    }), "\n", createVNode(_components.blockquote, {
      children: ["\n", createVNode(_components.p, {
        children: "为做区分，这里新建测试用例文件，文件名为 test_demo_allure.py"
      }), "\n"]
    }), "\n", createVNode(_components.pre, {
      class: "astro-code github-dark",
      style: {
      ...
      id: "运行测试用例生成-allure-报告",
      children: "运行测试用例生成 allure 报告"
    }), "\n", createVNode(_components.pre, {
      class: "astro-code github-dark",
      style: {
        backgroundColor: "#24292e",
      ...
      id: "查看-allure-报告",
      children: "查看 allure 报告"
    }), "\n", createVNode(_components.p, {
      children: "输入以下命令来启动 allure 服务并浏览器中查看 allure 报告"
    }), "\n", createVNode(_components.pre, {
      class: "astro-code github-dark",
      style: {
        backgroundColor: "#24292e",
      ...
      id: "调整-cicd-流程来支持-allure-报告",
      children: "调整 CI/CD 流程来支持 allure 报告"
    }), "\n", createVNode(_components.blockquote, {
      children: ["\n", createVNode(_components.p, {
        children: "以 github action 为例，其他 CI 工具类似"
      }), "\n"]
    }), "\n", createVNode(_components.p, {
      children: "更新.github/workflows/pytest.yml 文件内容来上传 allure 报告到 GitHub"
    }), "\n", createVNode(_components.pre, {
      class: "astro-code github-dark",
      style: {
        backgroundColor: "#24292e",
      ...
      id: "查看-github-action-allure-报告",
      children: "查看 github action allure 报告"
    }), "\n", createVNode(_components.p, {
      children: "在 GitHub 中，导航到你的仓库。单击上方的 Actions 选项卡，然后单击左侧的 Pytest API Testing 工作流。你应该会看到工作流正在运行，等待执行完成，就可以查看结果。"
    }), "\n", createVNode(_components.p, {
      children: createVNode(_components.img, {
...
const url = "src/blog/zh-cn/API-Automation-Testing/pytest-tutorial-advance-usage-multiple-environment-support-and-integration-allure-report.mdx";
const file = "/Users/nao.deng/Desktop/AwsomeCode/naodeng.com.cn/src/blog/zh-cn/API-Automation-Testing/pytest-tutorial-advance-usage-multiple-environment-support-and-integration-allure-report.mdx";
...
Content.moduleId = "/Users/nao.deng/Desktop/AwsomeCode/naodeng.com.cn/src/blog/zh-cn/API-Automation-Testing/pytest-tutorial-advance-usage-multiple-environment-support-and-integration-allure-report.mdx";
