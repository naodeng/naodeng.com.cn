...
const frontmatter = {
  ...
  "description": "这篇博文是关于 30 天 AI 测试挑战活动的第十三天，要求参与者开发自己的测试方法并成为 AI 测试的先行者。博文可能包括作者对于开发新的 AI 测试方法的思考和方法论，以及实际应用这些方法的经验和成果。通过分享自己的测试方法开发过程和成果，读者将了解到作者在 AI 测试领域的创新实践和领先地位，激发更多人尝试和探索 AI 在测试中的应用。这个系列活动有望为测试专业人士提供一个深入了解和实践 AI 测试方法开发的机会，并鼓励他们成为 AI 测试领域的先锋者。",
  "date": "2024-03-14T02:06:44.000Z",
  "author": "nao.deng",
  "tags": ["AI in Testing", "30 Days of AI in Testing"],
  "categories": ["软件测试活动"],
  "series": ["30 天 AI 测试挑战活动"],
  "cover": "./30-days-of-ai-in-testing-day-13-develop-a-testing-approach-and-become-an-ai-in-testing-champion-cover.png"
};
function getHeadings() {
  return [{
    "depth": 2,
    "slug": "第-13-天开发你的测试方法并成为-ai-测试的先行者",
    "text": "第 13 天：开发你的测试方法并成为 AI 测试的先行者"
  }, {
    "depth": 3,
    "slug": "任务步骤",
    "text": "任务步骤"
    ...
    "depth": 3,
    "slug": "2-关于引入-ai-到测试中的价值",
    "text": "2. 关于引入 AI 到测试中的价值"
  }, {
    "depth": 3,
    "slug": "3-关于成为-ai-测试的先行者",
    "text": "3. 关于成为 AI 测试的先行者"
  }, {
    "depth": 2,
    "slug": "关于活动",
    "text": "关于活动"
...
function _createMdxContent(props) {
  ...
  return createVNode(Fragment, {
    children: [createVNode(_components.h2, {
      id: "第-13-天开发你的测试方法并成为-ai-测试的先行者",
      children: "第 13 天：开发你的测试方法并成为 AI 测试的先行者"
    }), "\n", createVNode(_components.p, {
      children: "第 13 天来临了！在这短短的时间里，我们学习了许多内容。我们探究了 AI 如何在多种方式上支持测试和增强测试人员的能力。我们了解了使用 AI 的一些固有风险，并且尝试了一些工具。"
    }), "\n", createVNode(_components.p, {
      children: ["今天，我们要集中讨论如何利用我们所收集的信息来提升我们对测试的整体方法。AI 在测试中的应用并不会自然而然地发生——它需要 ", createVNode(_components.strong, {
        children: "AI 测试先行者"
      }), "。"]
      ...
      children: ["\n", createVNode(_components.li, {
        children: [createVNode(_components.strong, {
          children: "现状评估"
        }), "：考虑一下你的团队目前的测试实践，以及工作是如何从功能开发流转到产品交付的，测试在这个流程中扮演着什么角色。\n", createVNode(_components.ul, {
          children: ["\n", createVNode(_components.li, {
            children: ["思考一下与测试相关的各个活动，比如：\n", createVNode(_components.ul, {
              children: ["\n", createVNode(_components.li, {
                children: "测试数据管理"
              }), "\n", createVNode(_components.li, {
                children: "测试设计"
        ...
        children: [createVNode(_components.strong, {
          children: "AI 的价值所在"
        }), "：根据你到目前为止在挑战中的经验，以及其他人的贡献，思考：\n", createVNode(_components.ul, {
          children: ["\n", createVNode(_components.li, {
            children: "AI 在你的工作流程中能够带来最大价值的是哪一块？"
          }), "\n", createVNode(_components.li, {
            children: "选择一个（或多个，如果你愿意）你想要专注的改进领域"
          }), "\n", createVNode(_components.li, {
            children: "你会如何在该领域内使用 AI，它将会带来什么样的影响？"
          }), "\n", createVNode(_components.li, {
            children: "它会带来哪些 AI 风险，你将如何减轻这些风险？"
          }), "\n"]
        }), "\n"]
      }), "\n", createVNode(_components.li, {
        children: [createVNode(_components.strong, {
          children: "成为 AI 测试的先行者"
        }), "：设想你需要说服你的同事、经理或公司投资于 AI 测试。基于你之前的任务中的想法，制作一个视觉效果或简短的报告来概述你的策略。\n", createVNode(_components.ul, {
          children: ["\n", createVNode(_components.li, {
            children: "记录当前的情况和挑战"
          }), "\n", createVNode(_components.li, {
            children: "展示 AI 在测试中如何改善工作流程"
          }), "\n", createVNode(_components.li, {
            children: "概述任何风险以及如何应对"
          }), "\n", createVNode(_components.li, {
            children: "描述你的建议如何改善现状"
          }), "\n"]
        }), "\n"]
      }), "\n", createVNode(_components.li, {
        children: [createVNode(_components.strong, {
          children: "与你的 AiT 先行者同伴分享你的策略"
        }), "：通过回复这篇帖子来分享你的想法。\n", createVNode(_components.ul, {
          children: ["\n", createVNode(_components.li, {
            children: [createVNode(_components.strong, {
              children: "提醒"
            }), "：不要包括任何敏感信息，以防泄露你公司的机密"]
          }), "\n"]
        }), "\n"]
      }), "\n"]
    }), "\n", createVNode(_components.h3, {
      ...
      children: ["\n", createVNode(_components.li, {
        children: [createVNode(_components.strong, {
          children: "成为 AI 测试的先行者"
        }), "：在测试中采用 AI 需要人们理解它如何适用于测试并能够推广其使用。这个任务可以帮助你发展成为你组织中 AI 测试的先锋。"]
      }), "\n"]
    }), "\n", createVNode(_components.h3, {
      id: "任务链接",
      children: "任务链接"
      ...
      children: createVNode(_components.a, {
        href: "https://club.ministryoftesting.com/t/day-13-develop-a-testing-approach-and-become-an-ai-in-testing-champion/75103?cf_id=OZBDM2eTJ6L",
        children: "https://club.ministryoftesting.com/t/day-13-develop-a-testing-approach-and-become-an-ai-in-testing-champion/75103?cf_id=OZBDM2eTJ6L"
      })
      ...
      children: "我当前团队的测试实践中，QA 一直都扮演着质量分析人员的角色，不只是单纯的测试人员。项目从开发到交付，QA 从前到后都有参与，实施着测试左移和测试右移的敏捷实践。"
    }), "\n", createVNode(_components.p, {
      children: "目前与测试相关的各个活动中比较有挑战和耗时的是测试设计和测试执行工作。"
    }), "\n", createVNode(_components.ul, {
      children: ["\n", createVNode(_components.li, {
        children: "测试设计的效率和覆盖度需要改善"
      }), "\n", createVNode(_components.li, {
        children: "测试执行的效率和质量也需要提升和改进"
      }), "\n"]
    }), "\n", createVNode(_components.h3, {
      id: "2-关于引入-ai-到测试中的价值",
      children: "2. 关于引入 AI 到测试中的价值"
    }), "\n", createVNode(_components.p, {
      children: "一直尝试在项目测试过程中引入 AI 来帮助提升测试效率，如之前任务中一直提到的测试用例生成提示词优化，目前也在其他 QA 成员中进行推广和调优。"
    }), "\n", createVNode(_components.p, {
      children: "以下为持续优化中的测试用例生成提示词"
      ...
      children: "目前通过这个提示词一定程度上帮助我们提示了测试设计的效率和覆盖度。"
    }), "\n", createVNode(_components.p, {
      children: "除了在测试设计工作中引入 AI 以外，也会在 AI 测试数据生成和 AI API 自动化测试方面进行探索，希望在 AI 的帮助下能提升测试数据构造和 API 自动化测试的效率。"
    }), "\n", createVNode(_components.p, {
      children: "之前任务也提到，由于担心 AI 工具存在数据隐私安全的问题，没办法把当前项目的业务上下文全部丢给 AI 工具，需要进行模糊处理后再进行传递，这样也能降低数据隐私问题的风险，但同样也会影响到 AI 工具对测试设计结果生成准确性和覆盖度。"
    }), "\n", createVNode(_components.blockquote, {
      children: ["\n", createVNode(_components.p, {
        children: "上下文补充：当前项目周期较短，引入大规模自动化测试的价值有限，基本会以业务功能测试为主。"
      }), "\n"]
    }), "\n", createVNode(_components.h3, {
      id: "3-关于成为-ai-测试的先行者",
      ...
      children: "我目前一直在学习不同 AI 测试工具和 AI 测试提示词的过程中，由于项目的局限性和 AI 安全风险顾虑，还没找到真正能高效提升效率的 AI 测试提案。"
    }), "\n", createVNode(_components.p, {
      children: "但是最近学习的 Katalon 和 Applitools 等多个 AI 测试工具，其中 Katalon 的测试用例自主修复和 Applitools 的视觉 AI 识别，感觉后面能成功推广的可能性非常大，我会持续学习和使用 Katalon/Applitools 这两个 AI 测试工具，输出使用文档和 demo，并尝试在后续的项目中引入，希望后面能真实落地 AI 测试工具。"
    }), "\n", createVNode(_components.h2, {
      id: "关于活动",
      children: "关于活动"
    }), "\n", createVNode(_components.p, {
...
const url = "src/blog/zh-cn/Event/30-days-of-ai-in-testing-day-13-develop-a-testing-approach-and-become-an-ai-in-testing-champion.mdx";
const file = "/Users/nao.deng/Desktop/AwsomeCode/naodeng.com.cn/src/blog/zh-cn/Event/30-days-of-ai-in-testing-day-13-develop-a-testing-approach-and-become-an-ai-in-testing-champion.mdx";
...
Content.moduleId = "/Users/nao.deng/Desktop/AwsomeCode/naodeng.com.cn/src/blog/zh-cn/Event/30-days-of-ai-in-testing-day-13-develop-a-testing-approach-and-become-an-ai-in-testing-champion.mdx";
